...
// This sample demonstrates constructing a client from retrieved configuration.
//
// Learn more:
//   - Guide: https://github.com/opensearch-project/opensearch-go/blob/main/guides/config-envvars.md
