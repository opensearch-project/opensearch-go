...
// This sample demonstrates create, configure, and delete indices.
//
// Learn more:
//   - Guide: https://github.com/opensearch-project/opensearch-go/blob/main/guides/indexing-index_lifecycle.md
