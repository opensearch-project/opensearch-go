...
func TestIndicesGetUpgradeReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		name       string
		req        opensearchapi.IndicesGetUpgradeReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        opensearchapi.IndicesGetUpgradeReq{Index: []string{"a", "b"}},
			wantMethod: http.MethodGet,
...
func TestIndicesGetUpgrade_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Indices.GetUpgrade(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Indices.GetUpgrade(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
