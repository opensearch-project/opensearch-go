...
func TestIndicesGetUpgradeReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			req:        opensearchapi.IndicesGetUpgradeReq{Indices: []string{"a", "b"}},
			wantMethod: http.MethodGet,
...
func TestIndicesGetUpgrade_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Index.GetUpgrade(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Index.GetUpgrade(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
