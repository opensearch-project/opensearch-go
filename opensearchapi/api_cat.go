...
func (c catClient) Aliases(ctx context.Context, req *CatAliasesReq) (*CatAliasesResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Aliases); err != nil {
		return &data, err
	}
...
func (c catClient) Allocation(ctx context.Context, req *CatAllocationReq) (*CatAllocationsResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Allocations); err != nil {
		return &data, err
	}
...
func (c catClient) ClusterManager(ctx context.Context, req *CatClusterManagerReq) (*CatClusterManagersResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.ClusterManagers); err != nil {
		return &data, err
	}
...
func (c catClient) Count(ctx context.Context, req *CatCountReq) (*CatCountsResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Counts); err != nil {
		return &data, err
	}
...
func (c catClient) FieldData(ctx context.Context, req *CatFieldDataReq) (*CatFieldDataResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.FieldData); err != nil {
		return &data, err
	}
...
func (c catClient) Health(ctx context.Context, req *CatHealthReq) (*CatHealthResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Health); err != nil {
		return &data, err
	}
...
func (c catClient) Indices(ctx context.Context, req *CatIndicesReq) (*CatIndicesResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Indices); err != nil {
		return &data, err
	}
...
func (c catClient) Master(ctx context.Context, req *CatMasterReq) (*CatMasterResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Master); err != nil {
		return &data, err
	}
...
func (c catClient) NodeAttrs(ctx context.Context, req *CatNodeAttrsReq) (*CatNodeAttrsResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.NodeAttrs); err != nil {
		return &data, err
	}
...
func (c catClient) Nodes(ctx context.Context, req *CatNodesReq) (*CatNodesResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Nodes); err != nil {
		return &data, err
	}
...
func (c catClient) PendingTasks(ctx context.Context, req *CatPendingTasksReq) (*CatPendingTasksResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.PendingTasks); err != nil {
		return &data, err
	}
...
func (c catClient) Plugins(ctx context.Context, req *CatPluginsReq) (*CatPluginsResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Plugins); err != nil {
		return &data, err
	}
...
func (c catClient) Recovery(ctx context.Context, req *CatRecoveryReq) (*CatRecoveryResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Recovery); err != nil {
		return &data, err
	}
...
func (c catClient) Repositories(ctx context.Context, req *CatRepositoriesReq) (*CatRepositoriesResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Repositories); err != nil {
		return &data, err
	}
...
func (c catClient) Segments(ctx context.Context, req *CatSegmentsReq) (*CatSegmentsResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Segments); err != nil {
		return &data, err
	}
...
func (c catClient) Shards(ctx context.Context, req *CatShardsReq) (*CatShardsResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Shards); err != nil {
		return &data, err
	}
...
func (c catClient) Snapshots(ctx context.Context, req CatSnapshotsReq) (*CatSnapshotsResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Snapshots); err != nil {
		return &data, err
	}
...
func (c catClient) Tasks(ctx context.Context, req *CatTasksReq) (*CatTasksResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.Tasks); err != nil {
		return &data, err
	}
...
func (c catClient) ThreadPool(ctx context.Context, req *CatThreadPoolReq) (*CatThreadPoolResp, error) {
	...
	if data.response, err = do(ctx, c.apiClient, http.MethodGet, req, &data.ThreadPool); err != nil {
		return &data, err
	}
