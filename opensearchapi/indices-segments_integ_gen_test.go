...
func TestIndicesSegments(t *testing.T) {
	...
	index := testutil.MustUniqueString(t, "test-indices-segments")
	t.Cleanup(func() {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Index.Segments(t.Context(), &opensearchapi.IndicesSegmentsReq{Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Index.Segments(t.Context(), &opensearchapi.IndicesSegmentsReq{Indices: []string{index}})
		require.Error(t, err)
