...
func TestSearchShards(t *testing.T) {
	...
	index := testutil.MustUniqueString(t, "test-search-shards")
	t.Cleanup(func() {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.SearchShards(t.Context(), &opensearchapi.SearchShardsReq{Index: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.SearchShards(t.Context(), &opensearchapi.SearchShardsReq{Index: []string{index}})
		require.Error(t, err)
