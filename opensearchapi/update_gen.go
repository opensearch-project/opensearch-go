...
func (u *UpdateBodySource) String() (string, error) {
	...
	var zero string
	return zero, &UnionBranchError{Union: "UpdateBodySource", Want: "String", Got: u.typ.String()}
}
...
// *UnionBranchError when the union holds a different branch, naming the branch
// that is set; the returned value is the zero UpdateBodySourceExcludesIncludes in that case,
// which is indistinguishable from a decoded one, so check the error.
func (u *UpdateBodySource) ExcludesIncludes() (UpdateBodySourceExcludesIncludes, error) {
	...
	return zero, &UnionBranchError{Union: "UpdateBodySource", Want: "ExcludesIncludes", Got: u.typ.String()}
}
...
func (u *UpdateBodyScript) String() (string, error) {
	...
	var zero string
	return zero, &UnionBranchError{Union: "UpdateBodyScript", Want: "String", Got: u.typ.String()}
}
...
func (u *UpdateBodyScript) Stored() (StoredScriptID, error) {
	...
	return zero, &UnionBranchError{Union: "UpdateBodyScript", Want: "Stored", Got: u.typ.String()}
}
