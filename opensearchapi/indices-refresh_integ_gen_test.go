...
func TestIndicesRefresh(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Index.Refresh(t.Context(), &opensearchapi.IndicesRefreshReq{Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Index.Refresh(t.Context(), &opensearchapi.IndicesRefreshReq{Indices: []string{index}})
		require.Error(t, err)
