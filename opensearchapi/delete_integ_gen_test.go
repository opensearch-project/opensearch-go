...
func TestDelete(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Delete(t.Context(), opensearchapi.DeleteReq{Index: index, ID: docID})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Delete(t.Context(), opensearchapi.DeleteReq{Index: index, ID: docID})
		require.Error(t, err)
