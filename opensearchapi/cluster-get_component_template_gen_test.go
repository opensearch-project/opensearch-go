...
func TestClusterGetComponentTemplate_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cluster.GetComponentTemplate(t.Context(), opensearchapi.ClusterGetComponentTemplateReq{})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cluster.GetComponentTemplate(t.Context(), opensearchapi.ClusterGetComponentTemplateReq{})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
