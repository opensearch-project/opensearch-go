...
func TestClusterHealth(t *testing.T) {
	...
	index := testutil.MustUniqueString(t, "test-cluster-health")
	t.Cleanup(func() {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Cluster.Health(t.Context(), &opensearchapi.ClusterHealthReq{Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Cluster.Health(t.Context(), &opensearchapi.ClusterHealthReq{Indices: []string{index}})
		require.Error(t, err)
