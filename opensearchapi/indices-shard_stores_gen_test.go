...
func TestIndicesShardStoresReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        opensearchapi.IndicesShardStoresReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestIndicesShardStores_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Index.ShardStores(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Index.ShardStores(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
