...
func TestIndicesForceMergeReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			req:        opensearchapi.IndicesForceMergeReq{Indices: []string{"a", "b"}},
			wantMethod: http.MethodPost,
...
func TestIndicesForceMerge_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Index.ForceMerge(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Index.ForceMerge(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
