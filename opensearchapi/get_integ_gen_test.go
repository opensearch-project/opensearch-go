...
func TestGet(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Doc.Get(t.Context(), opensearchapi.GetReq{Index: index, ID: docID})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Doc.Get(t.Context(), opensearchapi.GetReq{Index: index, ID: docID})
		require.Error(t, err)
