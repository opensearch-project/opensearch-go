...
func TestCatAllPITSegmentsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        opensearchapi.CatAllPITSegmentsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_cat/pit_segments/_all",
			wantErr:    false,
		},
	}
...
func TestCatAllPITSegments_Roundtrip(t *testing.T) {
	t.Parallel()
