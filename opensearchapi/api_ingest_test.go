...
func TestIngestClient(t *testing.T) {
	...
	ingest := testutil.MustUniqueString(t, "test-ingest")
	t.Cleanup(func() {
		client.Ingest.Delete(context.Background(), opensearchapi.IngestDeleteReq{PipelineID: ingest})
	})
	...
	t.Run("ValidateResponse", func(t *testing.T) {
		t.Run("Get", func(t *testing.T) {
			t.Cleanup(func() {
				failingClient.Ingest.Delete(context.Background(), opensearchapi.IngestDeleteReq{PipelineID: ingest})
			})
