...
func TestClusterState(t *testing.T) {
	...
	index := testutil.MustUniqueString(t, "test-cluster-state")
	t.Cleanup(func() {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Cluster.State(t.Context(), &opensearchapi.ClusterStateReq{})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Cluster.State(t.Context(), &opensearchapi.ClusterStateReq{})
		require.Error(t, err)
