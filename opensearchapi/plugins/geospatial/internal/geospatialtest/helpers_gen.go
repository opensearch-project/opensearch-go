...
func NewClient(t *testing.T) (*geospatial.Client, error) {
	t.Helper()
	...
	return geospatial.NewClient(osClient), nil
}
...
func CreateFailingClient(t *testing.T) (*geospatial.Client, error) {
	t.Helper()
