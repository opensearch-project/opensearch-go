...
func NewClient(t *testing.T) (*search_relevance.Client, error) {
	t.Helper()
	...
	return search_relevance.NewClient(osClient), nil
}
...
func CreateFailingClient(t *testing.T) (*search_relevance.Client, error) {
	t.Helper()
