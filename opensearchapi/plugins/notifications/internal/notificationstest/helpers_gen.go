...
func NewClient(t *testing.T) (*notifications.Client, error) {
	t.Helper()
	...
	return notifications.NewClient(osClient), nil
}
...
func CreateFailingClient(t *testing.T) (*notifications.Client, error) {
	t.Helper()
