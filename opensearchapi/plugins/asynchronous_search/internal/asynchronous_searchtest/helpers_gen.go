...
package asynchronous_searchtest
...
func NewClient(t *testing.T) (*asynchronous_search.Client, error) {
	t.Helper()
	...
	return asynchronous_search.NewClient(osClient), nil
}
...
func CreateFailingClient(t *testing.T) (*asynchronous_search.Client, error) {
	t.Helper()
