...
// ExplainReq represents the request for the ppl.explain operation.
//
...
func (r ExplainReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.PPLExplainPath{}.Build()
	if err != nil {
		return nil, err
	}
...
// ExplainResp represents the response for the ppl.explain operation.
//
// Returns the execution plan for a PPL query.
//
// Available: >= 1.0.0.
