...
func TestCreateModel(t *testing.T) {
	...
	require.NoError(t, err)
	testutil.SkipIfVersion(t, osClient, "<", "2.19", "CreateModel")

	index := testutil.MustUniqueString(t, "test-create-model")
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Model.CreateModel(t.Context(), ltr.CreateModelReq{Store: name, ID: docID, Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Model.CreateModel(t.Context(), ltr.CreateModelReq{Store: name, ID: docID, Body: strings.NewReader("{}")})
		require.Error(t, err)
