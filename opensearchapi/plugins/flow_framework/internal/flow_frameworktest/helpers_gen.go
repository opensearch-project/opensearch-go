...
func NewClient(t *testing.T) (*flow_framework.Client, error) {
	t.Helper()
	...
	return flow_framework.NewClient(osClient), nil
}
...
func CreateFailingClient(t *testing.T) (*flow_framework.Client, error) {
	t.Helper()
