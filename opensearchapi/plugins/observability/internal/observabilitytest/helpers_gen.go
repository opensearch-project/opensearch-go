...
func NewClient(t *testing.T) (*observability.Client, error) {
	t.Helper()
	...
	return observability.NewClient(osClient), nil
}
...
func CreateFailingClient(t *testing.T) (*observability.Client, error) {
	t.Helper()
