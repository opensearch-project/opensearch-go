...
func TestCatTasksReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        opensearchapi.CatTasksReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestCatTasks_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cat.Tasks(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.Tasks(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
