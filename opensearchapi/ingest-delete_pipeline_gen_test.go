...
func TestIngestDeletePipelineReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		name       string
		req        opensearchapi.IngestDeletePipelineReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestIngestDeletePipeline_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Ingest.DeletePipeline(t.Context(), opensearchapi.IngestDeletePipelineReq{ID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Ingest.DeletePipeline(t.Context(), opensearchapi.IngestDeletePipelineReq{ID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
