...
func TestIndicesOpen(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Index.Open(t.Context(), &opensearchapi.IndicesOpenReq{Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Index.Open(t.Context(), &opensearchapi.IndicesOpenReq{Indices: []string{index}})
		require.Error(t, err)
