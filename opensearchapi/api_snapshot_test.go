...
func TestSnapshotClient(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		client.Snapshot.Delete(context.Background(), opensearchapi.SnapshotDeleteReq{
			Repo:      testRepo,
			Snapshots: []string{testSnapshot, testCloneSnapshot},
		})

		// Clean up repository
		client.Snapshot.Repository.Delete(context.Background(), opensearchapi.SnapshotRepositoryDeleteReq{
	...
	t.Run("ValidateResponse", func(t *testing.T) {
		...
		require.NoError(t, err)
		t.Cleanup(func() {
			client.Snapshot.Repository.Delete(context.Background(), opensearchapi.SnapshotRepositoryDeleteReq{Repos: []string{testRepo}})
		})
