...
func TestIndicesClearCache(t *testing.T) {
	...
	index := testutil.MustUniqueString(t, "test-indices-clear-cache")
	t.Cleanup(func() {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Index.ClearCache(t.Context(), &opensearchapi.IndicesClearCacheReq{Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Index.ClearCache(t.Context(), &opensearchapi.IndicesClearCacheReq{Indices: []string{index}})
		require.Error(t, err)
