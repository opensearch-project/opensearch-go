...
func TestIndicesSegmentsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        opensearchapi.IndicesSegmentsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestIndicesSegments_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Index.Segments(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Index.Segments(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
