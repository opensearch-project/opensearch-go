...
func TestIndicesGet(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Index.Get(t.Context(), &opensearchapi.IndicesGetReq{Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Index.Get(t.Context(), &opensearchapi.IndicesGetReq{Indices: []string{index}})
		require.Error(t, err)
