...
func TestIndicesForceMerge(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Index.ForceMerge(t.Context(), &opensearchapi.IndicesForceMergeReq{Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Index.ForceMerge(t.Context(), &opensearchapi.IndicesForceMergeReq{Indices: []string{index}})
		require.Error(t, err)
