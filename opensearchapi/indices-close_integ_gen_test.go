...
func TestIndicesClose(t *testing.T) {
	client, err := testutil.NewClient(t)
	require.NoError(t, err)

	index := testutil.MustUniqueString(t, "test-indices-close")
	t.Cleanup(func() {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Index.Close(t.Context(), &opensearchapi.IndicesCloseReq{Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Index.Close(t.Context(), &opensearchapi.IndicesCloseReq{Indices: []string{index}})
		require.Error(t, err)
