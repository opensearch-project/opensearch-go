...
func TestCatCount(t *testing.T) {
	...
	index := testutil.MustUniqueString(t, "test-cat-count")
	t.Cleanup(func() {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Cat.Count(t.Context(), &opensearchapi.CatCountReq{Params: &opensearchapi.CatCountParams{DebugParams: opensearchapi.DebugParams{Format: "json"}}, Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Cat.Count(t.Context(), &opensearchapi.CatCountReq{Indices: []string{index}})
		require.Error(t, err)
