...
func TestIndicesGetAliasReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		...
		},
		{
			...
			req:        opensearchapi.IndicesGetAliasReq{Name: []string{"a", "b"}, Index: []string{"a", "b"}},
			wantMethod: http.MethodGet,
...
func TestIndicesGetAlias_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Indices.GetAlias(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Indices.GetAlias(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
