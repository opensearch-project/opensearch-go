...
func TestIndicesGetAliasReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			req:        opensearchapi.IndicesGetAliasReq{Name: []string{"a", "b"}, Indices: []string{"a", "b"}},
			wantMethod: http.MethodGet,
...
func TestIndicesGetAlias_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Index.GetAlias(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Index.GetAlias(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
