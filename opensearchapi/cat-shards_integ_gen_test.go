...
func TestCatShards(t *testing.T) {
	...
	index := testutil.MustUniqueString(t, "test-cat-shards")
	t.Cleanup(func() {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Cat.Shards(t.Context(), &opensearchapi.CatShardsReq{Params: &opensearchapi.CatShardsParams{DebugParams: opensearchapi.DebugParams{Format: "json"}}, Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Cat.Shards(t.Context(), &opensearchapi.CatShardsReq{Indices: []string{index}})
		require.Error(t, err)
