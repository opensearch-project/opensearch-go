...
func TestIndicesResolveIndexReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		name       string
		req        opensearchapi.IndicesResolveIndexReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestIndicesResolveIndex_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Indices.ResolveIndex(t.Context(), &opensearchapi.IndicesResolveIndexReq{Name: []string{"test"}})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Indices.ResolveIndex(t.Context(), &opensearchapi.IndicesResolveIndexReq{Name: []string{"test"}})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
