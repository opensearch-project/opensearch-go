...
func TestCatIndices(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Cat.Indices(t.Context(), &opensearchapi.CatIndicesReq{Params: &opensearchapi.CatIndicesParams{DebugParams: opensearchapi.DebugParams{Format: "json"}}, Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Cat.Indices(t.Context(), &opensearchapi.CatIndicesReq{Indices: []string{index}})
		require.Error(t, err)
