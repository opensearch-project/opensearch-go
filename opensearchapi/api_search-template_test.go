...
func TestSearchTemplate(t *testing.T) {
	...
	t.Run("with request", func(t *testing.T) {
		resp, httpResp, err := client.SearchTemplate(
			nil,
			opensearchapi.SearchTemplateReq{
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, httpResp, err := failingClient.SearchTemplate(nil, opensearchapi.SearchTemplateReq{})
		assert.NotNil(t, err)
		assert.Nil(t, res)
		assert.NotNil(t, httpResp)
