...
func TestIndicesUpgrade(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Index.Upgrade(t.Context(), &opensearchapi.IndicesUpgradeReq{Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Index.Upgrade(t.Context(), &opensearchapi.IndicesUpgradeReq{Indices: []string{index}})
		require.Error(t, err)
