...
func TestIndicesFlush(t *testing.T) {
	client, err := testutil.NewClient(t)
	require.NoError(t, err)

	index := testutil.MustUniqueString(t, "test-indices-flush")
	t.Cleanup(func() {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Index.Flush(t.Context(), &opensearchapi.IndicesFlushReq{Indices: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Index.Flush(t.Context(), &opensearchapi.IndicesFlushReq{Indices: []string{index}})
		require.Error(t, err)
