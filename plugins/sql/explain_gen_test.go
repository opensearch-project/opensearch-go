...
func TestExplainReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantPath:   "/_plugins/_sql/_explain",
			wantErr:    false,
		},
	}
...
func TestExplain_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Explain(t.Context(), &sql.ExplainReq{BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Explain(t.Context(), &sql.ExplainReq{BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
