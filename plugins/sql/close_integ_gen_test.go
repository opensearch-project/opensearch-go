...
func TestClose(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Close(t.Context(), &sql.CloseReq{Body: &opensearchapi.SQLClose{}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Close(t.Context(), &sql.CloseReq{Body: &opensearchapi.SQLClose{}})
		require.Error(t, err)
