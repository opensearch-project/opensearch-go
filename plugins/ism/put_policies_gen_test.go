...
func TestPutPolicies_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.PutPolicies(t.Context(), &ism.PutPoliciesReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.PutPolicies(t.Context(), &ism.PutPoliciesReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
