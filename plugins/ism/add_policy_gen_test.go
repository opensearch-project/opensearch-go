...
func TestAddPolicy_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.AddPolicy(t.Context(), &ism.AddPolicyReq{BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.AddPolicy(t.Context(), &ism.AddPolicyReq{BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
