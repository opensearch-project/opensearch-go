...
func TestRefreshSearchAnalyzersReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ism.RefreshSearchAnalyzersReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestRefreshSearchAnalyzers_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.RefreshSearchAnalyzers(t.Context(), &ism.RefreshSearchAnalyzersReq{Indices: []string{"test"}})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.RefreshSearchAnalyzers(t.Context(), &ism.RefreshSearchAnalyzersReq{Indices: []string{"test"}})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
