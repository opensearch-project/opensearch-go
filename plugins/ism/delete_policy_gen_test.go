...
func TestDeletePolicyReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			req:        ism.DeletePolicyReq{PolicyID: "test-policyid"},
...
func TestDeletePolicy_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeletePolicy(t.Context(), ism.DeletePolicyReq{PolicyID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeletePolicy(t.Context(), ism.DeletePolicyReq{PolicyID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
