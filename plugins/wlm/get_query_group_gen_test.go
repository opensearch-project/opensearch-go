...
func TestGetQueryGroupReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        wlm.GetQueryGroupReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        wlm.GetQueryGroupReq{Name: "test-name"},
			wantMethod: http.MethodGet,
...
func TestGetQueryGroup_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetQueryGroup(t.Context(), wlm.GetQueryGroupReq{})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetQueryGroup(t.Context(), wlm.GetQueryGroupReq{})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
