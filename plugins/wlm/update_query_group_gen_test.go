...
func TestUpdateQueryGroupReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        wlm.UpdateQueryGroupReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        wlm.UpdateQueryGroupReq{Name: "test-name"},
...
func TestUpdateQueryGroup_Roundtrip(t *testing.T) {
	t.Parallel()
