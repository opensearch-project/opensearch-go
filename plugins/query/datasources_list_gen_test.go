...
func TestDatasourcesListReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        query.DatasourcesListReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestDatasourcesList_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DatasourcesList(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
