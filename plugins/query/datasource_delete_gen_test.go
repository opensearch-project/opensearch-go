...
func TestDatasourceDeleteReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        query.DatasourceDeleteReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestDatasourceDelete_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DatasourceDelete(t.Context(), query.DatasourceDeleteReq{DatasourceName: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DatasourceDelete(t.Context(), query.DatasourceDeleteReq{DatasourceName: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
