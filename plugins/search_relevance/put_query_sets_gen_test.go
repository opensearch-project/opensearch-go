...
func TestPutQuerySetsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        search_relevance.PutQuerySetsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestPutQuerySets_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.PutQuerySets(t.Context(), &search_relevance.PutQuerySetsReq{BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.PutQuerySets(t.Context(), &search_relevance.PutQuerySetsReq{BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
