...
// DeleteScheduledExperimentsReq represents the request for the search_relevance.delete_scheduled_experiments operation.
//
...
//
// Available: >= 3.4.0.
type DeleteScheduledExperimentsReq struct {
	...
	Params *DeleteScheduledExperimentsParams
}

// GetRequest builds the HTTP request from the structured fields.
func (r DeleteScheduledExperimentsReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.SearchRelevanceDeleteScheduledExperimentsPath{
...
// DeleteScheduledExperimentsParams represents query parameters for the DeleteScheduledExperimentsReq.
type DeleteScheduledExperimentsParams struct {
	opensearchapi.TimeoutParams
	opensearchapi.DebugParams
}

func (r DeleteScheduledExperimentsParams) get() map[string]string {
	var params map[string]string
	set := func(k, v string) {
		if params == nil {
...
// DeleteScheduledExperimentsResp represents the response for the search_relevance.delete_scheduled_experiments operation.
//
// Deletes a specified scheduled experiment.
//
// Available: >= 3.4.0.
type DeleteScheduledExperimentsResp struct {
...
func (r DeleteScheduledExperimentsResp) Inspect() Inspect {
...
func (r DeleteScheduledExperimentsResp) RawBody() io.Reader {
