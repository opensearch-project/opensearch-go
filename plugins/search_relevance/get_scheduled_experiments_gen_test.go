...
func TestGetScheduledExperimentsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
...
func TestGetScheduledExperiments_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetScheduledExperiments(t.Context(), search_relevance.GetScheduledExperimentsReq{})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetScheduledExperiments(t.Context(), search_relevance.GetScheduledExperimentsReq{})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
