...
func TestDeleteSearchConfigurationsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        search_relevance.DeleteSearchConfigurationsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestDeleteSearchConfigurations_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteSearchConfigurations(t.Context(), search_relevance.DeleteSearchConfigurationsReq{SearchConfigurationID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteSearchConfigurations(t.Context(), search_relevance.DeleteSearchConfigurationsReq{SearchConfigurationID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
