...
func TestGetQuerySetsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
...
func TestGetQuerySets_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetQuerySets(t.Context(), search_relevance.GetQuerySetsReq{})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetQuerySets(t.Context(), search_relevance.GetQuerySetsReq{})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
