...
// GetJudgmentsReq represents the request for the search_relevance.get_judgments operation.
//
// Gets judgments.
//
...
type GetJudgmentsReq struct {
	...
	Params *GetJudgmentsParams
}

// GetRequest builds the HTTP request from the structured fields.
func (r GetJudgmentsReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.SearchRelevanceGetJudgmentsPath{
...
// GetJudgmentsParams represents query parameters for the GetJudgmentsReq.
type GetJudgmentsParams struct {
	opensearchapi.TimeoutParams
	opensearchapi.DebugParams
}

func (r GetJudgmentsParams) get() map[string]string {
	var params map[string]string
	set := func(k, v string) {
		if params == nil {
...
// GetJudgmentsResp represents the response for the search_relevance.get_judgments operation.
//
// Gets judgments.
//
// Available: >= 3.1.0.
...
func (r GetJudgmentsResp) Inspect() Inspect {
...
func (r GetJudgmentsResp) RawBody() io.Reader {
