...
func TestGetJudgmentsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
...
func TestGetJudgments_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetJudgments(t.Context(), search_relevance.GetJudgmentsReq{})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetJudgments(t.Context(), search_relevance.GetJudgmentsReq{})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
