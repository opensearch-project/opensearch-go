...
// GetSearchConfigurationsReq represents the request for the search_relevance.get_search_configurations operation.
//
...
//
// Available: >= 3.1.0.
type GetSearchConfigurationsReq struct {
	...
	Params *GetSearchConfigurationsParams
}

// GetRequest builds the HTTP request from the structured fields.
func (r GetSearchConfigurationsReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.SearchRelevanceGetSearchConfigurationsPath{
...
// GetSearchConfigurationsParams represents query parameters for the GetSearchConfigurationsReq.
type GetSearchConfigurationsParams struct {
	opensearchapi.TimeoutParams
	opensearchapi.DebugParams
}

func (r GetSearchConfigurationsParams) get() map[string]string {
	var params map[string]string
	set := func(k, v string) {
		if params == nil {
...
// GetSearchConfigurationsResp represents the response for the search_relevance.get_search_configurations operation.
//
// Gets the search configurations.
//
// Available: >= 3.1.0.
type GetSearchConfigurationsResp struct {
...
func (r GetSearchConfigurationsResp) Inspect() Inspect {
...
func (r GetSearchConfigurationsResp) RawBody() io.Reader {
