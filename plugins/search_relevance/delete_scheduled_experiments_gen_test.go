...
func TestDeleteScheduledExperimentsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        search_relevance.DeleteScheduledExperimentsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        search_relevance.DeleteScheduledExperimentsReq{ExperimentID: "test-experimentid"},
...
func TestDeleteScheduledExperiments_Roundtrip(t *testing.T) {
	t.Parallel()
