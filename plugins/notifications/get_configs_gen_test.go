...
func TestGetConfigsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        notifications.GetConfigsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetConfigs_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetConfigs(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetConfigs(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
