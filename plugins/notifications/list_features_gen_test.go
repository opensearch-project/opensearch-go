...
func TestListFeaturesReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        notifications.ListFeaturesReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_notifications/features",
			wantErr:    false,
		},
	}
...
func TestListFeatures_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.ListFeatures(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
