...
func TestGetConfigReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        notifications.GetConfigReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        notifications.GetConfigReq{ConfigID: "test-configid"},
...
func TestGetConfig_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetConfig(t.Context(), notifications.GetConfigReq{ConfigID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetConfig(t.Context(), notifications.GetConfigReq{ConfigID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
