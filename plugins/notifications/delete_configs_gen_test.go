...
func TestDeleteConfigsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        notifications.DeleteConfigsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_notifications/configs",
			wantErr:    false,
		},
	}
...
func TestDeleteConfigs_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteConfigs(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteConfigs(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
