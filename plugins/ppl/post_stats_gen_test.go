...
func TestPostStatsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ppl.PostStatsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestPostStats_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.PostStats(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.PostStats(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
