...
func TestDeleteModel_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteModel(t.Context(), knn.DeleteModelReq{ModelID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteModel(t.Context(), knn.DeleteModelReq{ModelID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
