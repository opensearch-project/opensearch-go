...
func TestGetRolesReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetRolesReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetRoles_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetRoles(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetRoles(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
