...
func TestPostDashboardsInfoReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.PostDashboardsInfoReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_security/dashboardsinfo",
			wantErr:    false,
		},
	}
...
func TestPostDashboardsInfo_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.PostDashboardsInfo(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.PostDashboardsInfo(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
