...
func (r GetRoleMappingReq) GetRequest(method string) (*http.Request, error) {
...
// GetRoleMappingResp represents the response for the GetRoleMapping operation.
...
func (r *GetRoleMappingResp) UnmarshalJSON(b []byte) error {
	return json.Unmarshal(b, &r.Entries)
}

// MarshalJSON encodes the response body for comparison testing.
func (r GetRoleMappingResp) MarshalJSON() ([]byte, error) {
...
func (r GetRoleMappingResp) RawBody() io.Reader {
