...
func TestGetPermissionsInfoReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetPermissionsInfoReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_security/api/permissionsinfo",
			wantErr:    false,
		},
	}
...
func TestGetPermissionsInfo_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetPermissionsInfo(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
