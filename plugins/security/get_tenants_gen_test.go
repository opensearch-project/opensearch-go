...
func TestGetTenants_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetTenants(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetTenants(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
