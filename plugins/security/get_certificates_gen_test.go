...
func TestGetCertificatesReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetCertificatesReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_security/api/ssl/certs",
			wantErr:    false,
		},
	}
...
func TestGetCertificates_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetCertificates(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetCertificates(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
