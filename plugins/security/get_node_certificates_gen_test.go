...
func TestGetNodeCertificates_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetNodeCertificates(t.Context(), security.GetNodeCertificatesReq{NodeID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetNodeCertificates(t.Context(), security.GetNodeCertificatesReq{NodeID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
