...
func TestConfigUpgradeCheckReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.ConfigUpgradeCheckReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_security/api/_upgrade_check",
			wantErr:    false,
		},
	}
...
func TestConfigUpgradeCheck_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.ConfigUpgradeCheck(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
