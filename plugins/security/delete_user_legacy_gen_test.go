...
func TestDeleteUserLegacy_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteUserLegacy(t.Context(), security.DeleteUserLegacyReq{Username: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteUserLegacy(t.Context(), security.DeleteUserLegacyReq{Username: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
