...
func TestGetSslinfoReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetSslinfoReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_opendistro/_security/sslinfo",
			wantErr:    false,
		},
	}
...
func TestGetSslinfo_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetSslinfo(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
