...
func TestGetUsersLegacyReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetUsersLegacyReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_security/api/user",
			wantErr:    false,
		},
	}
...
func TestGetUsersLegacy_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetUsersLegacy(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetUsersLegacy(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
