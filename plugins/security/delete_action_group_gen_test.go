...
func TestDeleteActionGroupReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.DeleteActionGroupReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        security.DeleteActionGroupReq{ActionGroup: "test-actiongroup"},
...
func TestDeleteActionGroup_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteActionGroup(t.Context(), security.DeleteActionGroupReq{ActionGroup: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteActionGroup(t.Context(), security.DeleteActionGroupReq{ActionGroup: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
