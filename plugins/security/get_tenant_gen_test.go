...
func TestGetTenantReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetTenantReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        security.GetTenantReq{Tenant: "test-tenant"},
...
func TestGetTenant_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetTenant(t.Context(), security.GetTenantReq{Tenant: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetTenant(t.Context(), security.GetTenantReq{Tenant: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
