...
func TestGetRoleReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetRoleReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        security.GetRoleReq{Role: "test-role"},
...
func TestGetRole_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetRole(t.Context(), security.GetRoleReq{Role: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetRole(t.Context(), security.GetRoleReq{Role: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
