...
func TestGetAuditConfiguration_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetAuditConfiguration(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetAuditConfiguration(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
