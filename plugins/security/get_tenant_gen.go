...
func (r GetTenantReq) GetRequest(method string) (*http.Request, error) {
...
// GetTenantResp represents the response for the GetTenant operation.
...
func (r GetTenantResp) RawBody() io.Reader {
