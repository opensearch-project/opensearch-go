...
func TestGetActionGroupsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetActionGroupsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetActionGroups_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetActionGroups(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetActionGroups(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
