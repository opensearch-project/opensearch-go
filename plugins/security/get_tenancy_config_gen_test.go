...
func TestGetTenancyConfigReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetTenancyConfigReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetTenancyConfig_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetTenancyConfig(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetTenancyConfig(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
