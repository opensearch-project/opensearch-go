...
type PatchAuditConfigurationReq struct {
...
func (r PatchAuditConfigurationReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.SecurityPatchAuditConfigurationPath{}.Build()
	if err != nil {
		return nil, err
	}
...
// PatchAuditConfigurationResp represents the response for the security.patch_audit_configuration operation.
//
// Updates the specified fields in the audit configuration.
//
// Available: >= 1.0.0.
//
// See: https://opensearch.org/docs/latest/security/access-control/api/#audit-logs
type PatchAuditConfigurationResp struct {
...
func (r PatchAuditConfigurationResp) Inspect() Inspect {
...
func (r PatchAuditConfigurationResp) RawBody() io.Reader {
