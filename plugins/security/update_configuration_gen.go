...
func (r UpdateConfigurationReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.SecurityUpdateConfigurationPath{}.Build()
	if err != nil {
		return nil, err
	}
...
// UpdateConfigurationResp represents the response for the security.update_configuration operation.
//
// Updates the settings for an existing security configuration. Requires super admin or REST API permissions.
//
// Available: >= 2.10.0.
...
func (r UpdateConfigurationResp) Inspect() Inspect {
...
func (r UpdateConfigurationResp) RawBody() io.Reader {
