...
// Package security wraps the OpenSearch security plugin API.
//
...
//
//   - client.ActionGroup reaches [ActionGroupClient]
//   - client.Allowlist reaches [AllowlistClient]
//   - client.AuditConfiguration reaches [AuditConfigurationClient]
//   - client.Certificate reaches [CertificateClient]
//   - client.Configuration reaches [ConfigurationClient]
//   - client.DashboardInfo reaches [DashboardInfoClient]
//   - client.DistinguishedName reaches [DistinguishedNameClient]
//   - client.Role reaches [RoleClient]
//   - client.RoleMapping reaches [RoleMappingClient]
//   - client.TenancyConfig reaches [TenancyConfigClient]
//   - client.Tenant reaches [TenantClient]
//   - client.User reaches [UserClient]
//   - client.UserLegacy reaches [UserLegacyClient]
package security
...
func (c ActionGroupClient) PatchActionGroup(ctx context.Context, req PatchActionGroupReq) (*PatchActionGroupResp, error) {
	...
	var err error
	if resp.response, err = request(ctx, c.client, http.MethodPatch, req, &resp); err != nil {
		return &resp, err
	}
	return &resp, nil
}
