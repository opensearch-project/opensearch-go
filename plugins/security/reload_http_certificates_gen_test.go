...
func TestReloadHTTPCertificatesReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
...
func TestReloadHTTPCertificates_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.ReloadHTTPCertificates(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
