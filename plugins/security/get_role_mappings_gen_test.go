...
func TestGetRoleMappingsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetRoleMappingsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetRoleMappings_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetRoleMappings(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetRoleMappings(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
