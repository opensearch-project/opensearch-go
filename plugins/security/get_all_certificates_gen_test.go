...
func TestGetAllCertificatesReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetAllCertificatesReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_security/api/certificates",
			wantErr:    false,
		},
	}
...
func TestGetAllCertificates_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetAllCertificates(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetAllCertificates(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
