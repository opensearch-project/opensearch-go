...
func TestPatchAllowlistReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.PatchAllowlistReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestPatchAllowlist_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.PatchAllowlist(t.Context(), &security.PatchAllowlistReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.PatchAllowlist(t.Context(), &security.PatchAllowlistReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
