...
func TestPatchUsersReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.PatchUsersReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_security/api/internalusers",
			wantErr:    false,
		},
	}
...
func TestPatchUsers_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.PatchUsers(t.Context(), &security.PatchUsersReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.PatchUsers(t.Context(), &security.PatchUsersReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
