...
func TestTenantInfoReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.TenantInfoReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_security/tenantinfo",
			wantErr:    false,
		},
	}
...
func TestTenantInfo_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.TenantInfo(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
