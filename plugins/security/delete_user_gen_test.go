...
func TestDeleteUserReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.DeleteUserReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        security.DeleteUserReq{Username: "test-username"},
...
func TestDeleteUser_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteUser(t.Context(), security.DeleteUserReq{Username: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteUser(t.Context(), security.DeleteUserReq{Username: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
