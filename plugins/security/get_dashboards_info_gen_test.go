...
func TestGetDashboardsInfoReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetDashboardsInfoReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetDashboardsInfo_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetDashboardsInfo(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetDashboardsInfo(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
