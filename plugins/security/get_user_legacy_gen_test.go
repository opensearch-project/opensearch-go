...
func TestGetUserLegacyReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetUserLegacyReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetUserLegacy_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetUserLegacy(t.Context(), security.GetUserLegacyReq{Username: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetUserLegacy(t.Context(), security.GetUserLegacyReq{Username: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
