...
func TestDeleteRoleReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.DeleteRoleReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        security.DeleteRoleReq{Role: "test-role"},
...
func TestDeleteRole_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteRole(t.Context(), security.DeleteRoleReq{Role: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteRole(t.Context(), security.DeleteRoleReq{Role: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
