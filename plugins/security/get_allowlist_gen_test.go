...
func TestGetAllowlistReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetAllowlistReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetAllowlist_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetAllowlist(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetAllowlist(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
