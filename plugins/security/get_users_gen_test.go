...
func TestGetUsersReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetUsersReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetUsers_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetUsers(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetUsers(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
