...
func TestPatchActionGroupReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.PatchActionGroupReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        security.PatchActionGroupReq{ActionGroup: "test-actiongroup"},
...
func TestPatchActionGroup_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.PatchActionGroup(t.Context(), security.PatchActionGroupReq{ActionGroup: "test", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.PatchActionGroup(t.Context(), security.PatchActionGroupReq{ActionGroup: "test", Body: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
