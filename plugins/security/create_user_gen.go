...
func (r CreateUserReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.SecurityCreateUserPath{
		Username: r.Username,
	}.Build()
	if err != nil {
		return nil, err
...
// CreateUserResp represents the response for the security.create_user operation.
//
// Creates or replaces the specified user.
//
// Available: >= 1.0.0.
...
func (r CreateUserResp) Inspect() Inspect {
...
func (r CreateUserResp) RawBody() io.Reader {
