...
func TestGetDistinguishedNamesReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetDistinguishedNamesReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetDistinguishedNames_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetDistinguishedNames(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetDistinguishedNames(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
