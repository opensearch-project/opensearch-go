...
func TestUpdateAuditConfigurationReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
...
func TestUpdateAuditConfiguration_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.UpdateAuditConfiguration(t.Context(), &security.UpdateAuditConfigurationReq{BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.UpdateAuditConfiguration(t.Context(), &security.UpdateAuditConfigurationReq{BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
