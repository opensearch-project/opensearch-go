...
type UpdateAuditConfigurationReq struct {
	...
	Body *opensearchapi.SecurityAuditConfig
...
func (r UpdateAuditConfigurationReq) GetRequest(method string) (*http.Request, error) {
...
func (r UpdateAuditConfigurationResp) RawBody() io.Reader {
