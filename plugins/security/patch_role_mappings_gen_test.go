...
func TestPatchRoleMappingsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.PatchRoleMappingsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_security/api/rolesmapping",
			wantErr:    false,
		},
	}
...
func TestPatchRoleMappings_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.PatchRoleMappings(t.Context(), &security.PatchRoleMappingsReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.PatchRoleMappings(t.Context(), &security.PatchRoleMappingsReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
