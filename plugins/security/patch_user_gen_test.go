...
func TestPatchUserReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.PatchUserReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestPatchUser_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.PatchUser(t.Context(), security.PatchUserReq{Username: "test", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.PatchUser(t.Context(), security.PatchUserReq{Username: "test", Body: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
