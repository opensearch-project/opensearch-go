...
func TestCreateTenantReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.CreateTenantReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        security.CreateTenantReq{Tenant: "test-tenant"},
...
func TestCreateTenant_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.CreateTenant(t.Context(), security.CreateTenantReq{Tenant: "test", BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.CreateTenant(t.Context(), security.CreateTenantReq{Tenant: "test", BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
