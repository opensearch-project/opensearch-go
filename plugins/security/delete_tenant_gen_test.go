...
func TestDeleteTenantReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.DeleteTenantReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestDeleteTenant_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteTenant(t.Context(), security.DeleteTenantReq{Tenant: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteTenant(t.Context(), security.DeleteTenantReq{Tenant: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
