...
func TestAuthtokenReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.AuthtokenReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_security/api/authtoken",
			wantErr:    false,
		},
	}
...
func TestAuthtoken_Roundtrip(t *testing.T) {
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Authtoken(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
