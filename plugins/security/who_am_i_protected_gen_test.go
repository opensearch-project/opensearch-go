...
func TestWhoAmIProtectedReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.WhoAmIProtectedReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_security/whoamiprotected",
			wantErr:    false,
		},
	}
...
func TestWhoAmIProtected_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.WhoAmIProtected(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
