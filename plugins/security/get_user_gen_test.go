...
func TestGetUserReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        security.GetUserReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        security.GetUserReq{Username: "test-username"},
...
func TestGetUser_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetUser(t.Context(), security.GetUserReq{Username: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetUser(t.Context(), security.GetUserReq{Username: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
