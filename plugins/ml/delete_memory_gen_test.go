...
func TestDeleteMemoryReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.DeleteMemoryReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestDeleteMemory_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteMemory(t.Context(), ml.DeleteMemoryReq{MemoryID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteMemory(t.Context(), ml.DeleteMemoryReq{MemoryID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
