...
func TestGetAgenticMemoryReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.GetAgenticMemoryReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetAgenticMemory_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetAgenticMemory(t.Context(), ml.GetAgenticMemoryReq{MemoryContainerID: "test", Type: "test", ID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetAgenticMemory(t.Context(), ml.GetAgenticMemoryReq{MemoryContainerID: "test", Type: "test", ID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
