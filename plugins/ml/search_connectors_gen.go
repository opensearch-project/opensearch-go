...
// been decoded.
func (t MLSearchConnectorsBodySortType) String() string {
	switch t {
	case MLSearchConnectorsBodySortStringType:
		return "String"
	case MLSearchConnectorsBodySortStringMapType:
		return "StringMap"
	case MLSearchConnectorsBodySortFieldSortMapType:
		return "FieldSortMap"
	case MLSearchConnectorsBodySortOptionsType:
		return "Options"
	default:
		return "unknown"
	}
