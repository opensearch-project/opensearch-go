...
func TestGetProfileModelsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
...
func TestGetProfileModels_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetProfileModels(t.Context(), ml.GetProfileModelsReq{})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
