...
func TestUpdateMemoryReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.UpdateMemoryReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        ml.UpdateMemoryReq{MemoryID: "test-memoryid"},
...
func TestUpdateMemory_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.UpdateMemory(t.Context(), ml.UpdateMemoryReq{MemoryID: "test", BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.UpdateMemory(t.Context(), ml.UpdateMemoryReq{MemoryID: "test", BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
