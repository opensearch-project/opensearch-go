...
func TestDeleteTaskReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.DeleteTaskReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        ml.DeleteTaskReq{TaskID: "test-taskid"},
			wantMethod: http.MethodDelete,
			wantPath:   "/_plugins/_ml/tasks/test-taskid",
			wantErr:    false,
		},
	}
...
func TestDeleteTask_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteTask(t.Context(), ml.DeleteTaskReq{TaskID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteTask(t.Context(), ml.DeleteTaskReq{TaskID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
