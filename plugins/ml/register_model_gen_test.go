...
func TestRegisterModelReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.RegisterModelReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_ml/models/_register",
			wantErr:    false,
		},
	}
...
func TestRegisterModel_Roundtrip(t *testing.T) {
	t.Parallel()
