...
func TestUpdateConnectorReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.UpdateConnectorReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestUpdateConnector_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.UpdateConnector(t.Context(), ml.UpdateConnectorReq{ConnectorID: "test", BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.UpdateConnector(t.Context(), ml.UpdateConnectorReq{ConnectorID: "test", BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
