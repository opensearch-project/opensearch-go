...
// DeleteConnectorReq represents the request for the ml.delete_connector operation.
//
...
func (r DeleteConnectorReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.MLDeleteConnectorPath{
...
// DeleteConnectorParams represents query parameters for the DeleteConnectorReq.
type DeleteConnectorParams struct {
	opensearchapi.TimeoutParams
	opensearchapi.DebugParams
}

func (r DeleteConnectorParams) get() map[string]string {
	var params map[string]string
	set := func(k, v string) {
		if params == nil {
...
// DeleteConnectorResp represents the response for the ml.delete_connector operation.
//
// Deletes a standalone connector.
...
func (r DeleteConnectorResp) Inspect() Inspect {
...
func (r DeleteConnectorResp) RawBody() io.Reader {
