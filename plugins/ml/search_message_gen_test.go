...
func TestSearchMessageReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.SearchMessageReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestSearchMessage_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.SearchMessage(t.Context(), ml.SearchMessageReq{MemoryID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.SearchMessage(t.Context(), ml.SearchMessageReq{MemoryID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
