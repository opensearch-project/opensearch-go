...
func TestTrainPredictReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.TrainPredictReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestTrainPredict_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.TrainPredict(t.Context(), ml.TrainPredictReq{AlgorithmName: "test", BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.TrainPredict(t.Context(), ml.TrainPredictReq{AlgorithmName: "test", BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
