...
func (u *MLSearchMessageBodySort) String() (string, error) {
	...
	var zero string
	return zero, &opensearchapi.UnionBranchError{Union: "MLSearchMessageBodySort", Want: "String", Got: u.typ.String()}
}
...
func (u *MLSearchMessageBodySort) StringMap() (map[string]string, error) {
	...
	return zero, &opensearchapi.UnionBranchError{Union: "MLSearchMessageBodySort", Want: "StringMap", Got: u.typ.String()}
}
...
func (u *MLSearchMessageBodySort) FieldSortMap() (map[string]opensearchapi.FieldSort, error) {
	...
	return zero, &opensearchapi.UnionBranchError{Union: "MLSearchMessageBodySort", Want: "FieldSortMap", Got: u.typ.String()}
}
...
func (u *MLSearchMessageBodySort) Options() (opensearchapi.SortOptions, error) {
	...
	return zero, &opensearchapi.UnionBranchError{Union: "MLSearchMessageBodySort", Want: "Options", Got: u.typ.String()}
}
