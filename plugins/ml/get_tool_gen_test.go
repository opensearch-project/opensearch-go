...
func TestGetToolReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.GetToolReq
		...
		},
		{
			...
			req:        ml.GetToolReq{ToolName: "test-toolname"},
			wantMethod: http.MethodGet,
			wantPath:   "/_plugins/_ml/tools/test-toolname",
			wantErr:    false,
		},
	}
...
func TestGetTool_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetTool(t.Context(), ml.GetToolReq{ToolName: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetTool(t.Context(), ml.GetToolReq{ToolName: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
