...
func TestSearchAgentsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
...
func TestSearchAgents_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.SearchAgents(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.SearchAgents(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
