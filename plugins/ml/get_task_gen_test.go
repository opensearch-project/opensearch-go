...
func TestGetTaskReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.GetTaskReq
		...
		},
		{
			...
			req:        ml.GetTaskReq{TaskID: "test-taskid"},
...
func TestGetTask_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetTask(t.Context(), ml.GetTaskReq{TaskID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetTask(t.Context(), ml.GetTaskReq{TaskID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
