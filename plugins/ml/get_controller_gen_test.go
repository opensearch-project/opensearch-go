...
func TestGetControllerReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.GetControllerReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetController_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetController(t.Context(), ml.GetControllerReq{ModelID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetController(t.Context(), ml.GetControllerReq{ModelID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
