...
//
// Available: >= 3.3.0.
type UpdateMemoryContainerReq struct {
	...
	Body *MLUpdateMemoryContainerBody
	...
	Params *UpdateMemoryContainerParams
}

// GetRequest builds the HTTP request from the structured fields.
func (r UpdateMemoryContainerReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.MLUpdateMemoryContainerPath{
...
// UpdateMemoryContainerResp represents the response for the ml.update_memory_container operation.
//
// Update a memory container.
//
// Available: >= 3.3.0.
type UpdateMemoryContainerResp struct {
...
func (r UpdateMemoryContainerResp) Inspect() Inspect {
...
func (r UpdateMemoryContainerResp) RawBody() io.Reader {
