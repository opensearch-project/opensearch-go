...
func TestDeleteModelGroupReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.DeleteModelGroupReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestDeleteModelGroup_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteModelGroup(t.Context(), ml.DeleteModelGroupReq{ModelGroupID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteModelGroup(t.Context(), ml.DeleteModelGroupReq{ModelGroupID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
