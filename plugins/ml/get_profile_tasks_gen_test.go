...
func TestGetProfileTasksReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
...
func TestGetProfileTasks_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetProfileTasks(t.Context(), ml.GetProfileTasksReq{})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
