...
func TestGetProfileReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ml.GetProfileReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetProfile_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetProfile(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
