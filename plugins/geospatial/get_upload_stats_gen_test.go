...
func TestGetUploadStatsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        geospatial.GetUploadStatsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/geospatial/_upload/stats",
			wantErr:    false,
		},
	}
...
func TestGetUploadStats_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetUploadStats(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
