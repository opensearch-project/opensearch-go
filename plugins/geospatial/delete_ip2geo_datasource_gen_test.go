...
func TestDeleteIP2GeoDatasourceReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        geospatial.DeleteIP2GeoDatasourceReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestDeleteIP2GeoDatasource_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteIP2GeoDatasource(t.Context(), geospatial.DeleteIP2GeoDatasourceReq{Name: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteIP2GeoDatasource(t.Context(), geospatial.DeleteIP2GeoDatasourceReq{Name: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
