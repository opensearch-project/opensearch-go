...
func TestListObjectsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        observability.ListObjectsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestListObjects_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.ListObjects(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.ListObjects(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
