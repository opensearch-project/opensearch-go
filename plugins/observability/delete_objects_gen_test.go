...
func TestDeleteObjectsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        observability.DeleteObjectsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_observability/object",
			wantErr:    false,
		},
	}
...
func TestDeleteObjects_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeleteObjects(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeleteObjects(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
