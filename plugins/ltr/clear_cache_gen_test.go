...
func TestClearCacheReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
...
func TestClearCache_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.ClearCache(t.Context(), ltr.ClearCacheReq{})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.ClearCache(t.Context(), ltr.ClearCacheReq{})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
