...
func TestListStoresReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ltr.ListStoresReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestListStores_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.ListStores(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.ListStores(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
