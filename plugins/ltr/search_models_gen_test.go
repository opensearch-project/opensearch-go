...
func TestSearchModelsReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantPath:   "/_ltr/_model",
			wantErr:    false,
		},
		{
			name:       "all path fields",
			req:        ltr.SearchModelsReq{Store: "test-store"},
			wantMethod: http.MethodGet,
			wantPath:   "/_ltr/test-store/_model",
			wantErr:    false,
		},
	}
...
func TestSearchModels_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.SearchModels(t.Context(), ltr.SearchModelsReq{})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.SearchModels(t.Context(), ltr.SearchModelsReq{})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
