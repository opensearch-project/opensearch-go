...
// CreateModelFromSetReq represents the request for the ltr.create_model_from_set operation.
//
...
//
// Available: >= 2.19.0.
type CreateModelFromSetReq struct {
	...
	Params *CreateModelFromSetParams
}

// GetRequest builds the HTTP request from the structured fields.
func (r CreateModelFromSetReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.LTRCreateModelFromSetPath{
		Name:  r.Name,
		Store: r.Store,
	}.Build()
	if err != nil {
...
// CreateModelFromSetParams represents query parameters for the CreateModelFromSetReq.
type CreateModelFromSetParams struct {
...
func (r CreateModelFromSetParams) get() map[string]string {
	var params map[string]string
	set := func(k, v string) {
		if params == nil {
...
// CreateModelFromSetResp represents the response for the ltr.create_model_from_set operation.
//
// Create a model from an existing feature set in the default feature store.
//
// Available: >= 2.19.0.
type CreateModelFromSetResp struct {
...
func (r CreateModelFromSetResp) Inspect() Inspect {
...
func (r CreateModelFromSetResp) RawBody() io.Reader {
