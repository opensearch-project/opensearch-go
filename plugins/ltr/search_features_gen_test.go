...
func TestSearchFeaturesReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
...
func TestSearchFeatures_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.SearchFeatures(t.Context(), ltr.SearchFeaturesReq{})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.SearchFeatures(t.Context(), ltr.SearchFeaturesReq{})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
