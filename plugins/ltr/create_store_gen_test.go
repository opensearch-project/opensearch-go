...
func TestCreateStoreReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			req:        ltr.CreateStoreReq{Store: "test-store"},
...
func TestCreateStore_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.CreateStore(t.Context(), ltr.CreateStoreReq{Store: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.CreateStore(t.Context(), ltr.CreateStoreReq{Store: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
