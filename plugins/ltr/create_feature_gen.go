...
// CreateFeatureReq represents the request for the ltr.create_feature operation.
//
...
func (r CreateFeatureReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.LTRCreateFeaturePath{
		ID:    r.ID,
		Store: r.Store,
	}.Build()
	if err != nil {
...
// CreateFeatureParams represents query parameters for the CreateFeatureReq.
...
func (r CreateFeatureParams) get() map[string]string {
	var params map[string]string
	set := func(k, v string) {
		if params == nil {
...
// CreateFeatureResp represents the response for the ltr.create_feature operation.
//
// Create or update a feature in the default feature store.
//
// Available: >= 2.19.0.
type CreateFeatureResp struct {
...
func (r CreateFeatureResp) Inspect() Inspect {
...
func (r CreateFeatureResp) RawBody() io.Reader {
