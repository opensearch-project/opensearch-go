...
func TestGetFeatureReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ltr.GetFeatureReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        ltr.GetFeatureReq{ID: "test-id", Store: "test-store"},
...
func TestGetFeature_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetFeature(t.Context(), ltr.GetFeatureReq{ID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetFeature(t.Context(), ltr.GetFeatureReq{ID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
