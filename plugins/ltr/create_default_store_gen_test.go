...
func TestCreateDefaultStoreReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        ltr.CreateDefaultStoreReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestCreateDefaultStore_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.CreateDefaultStore(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.CreateDefaultStore(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
