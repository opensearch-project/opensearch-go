...
func TestDelete_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Delete(t.Context(), flow_framework.DeleteReq{WorkflowID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Delete(t.Context(), flow_framework.DeleteReq{WorkflowID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
