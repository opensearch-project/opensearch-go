...
func TestUpdateReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        flow_framework.UpdateReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        flow_framework.UpdateReq{WorkflowID: "test-workflowid"},
...
func TestUpdate_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Update(t.Context(), flow_framework.UpdateReq{WorkflowID: "test", BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Update(t.Context(), flow_framework.UpdateReq{WorkflowID: "test", BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
