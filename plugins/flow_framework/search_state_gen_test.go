...
func TestSearchStateReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        flow_framework.SearchStateReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_flow_framework/workflow/state/_search",
			wantErr:    false,
		},
	}
...
func TestSearchState_Roundtrip(t *testing.T) {
	t.Parallel()
