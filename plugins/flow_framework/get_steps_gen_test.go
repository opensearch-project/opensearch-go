...
func TestGetStepsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        flow_framework.GetStepsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			wantPath:   "/_plugins/_flow_framework/workflow/_steps",
			wantErr:    false,
		},
	}
...
func TestGetSteps_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetSteps(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
