...
type FlowFrameworkCommonWorkflowStep struct {
	// Inputs is the list of required inputs for the workflow step.
	Inputs []string `json:"inputs,omitempty"`

	// Outputs is the list of outputs generated by the workflow step.
	Outputs []string `json:"outputs,omitempty"`

	// RequiredPlugins is the list of plugins required for the workflow step.
	RequiredPlugins []string `json:"required_plugins,omitempty"`

	// Timeout is a duration. Units can be `nanos`, `micros`, `ms`
