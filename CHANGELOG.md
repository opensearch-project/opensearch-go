...
- Remove the unpinned `latest` target from the compatibility CI matrix so every job represents a supported, reproducible OpenSearch version ([#925](https://github.com/opensearch-project/opensearch-go/issues/925))
