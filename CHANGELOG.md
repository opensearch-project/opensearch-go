...
- Add `plugins/mlcommons` package providing a typed client for the ML Commons plugin: Models (Register/Get/Update/Deploy/Undeploy/Delete/Search/Predict/UploadChunk) and Tasks (Get/Delete/Search) ([#723](https://github.com/opensearch-project/opensearch-go/issues/723))
