...
- Add `OPENSEARCH_GO_SHARD_COST` environment variable and `WithShardCosts()` router option to override shard cost multipliers at runtime for connection scoring tuning
