...
func TestHealthCheckConfiguration(t *testing.T) {
	...
	t.Run("Custom health check function", func(t *testing.T) {
		...
		customHealthCheck := func(ctx context.Context, _ *Connection, u *url.URL) (*http.Response, error) {
...
func TestNoOpHealthCheck(t *testing.T) {
	ctx := context.Background()
	serverURL, _ := url.Parse("http://example.com:" + strconv.Itoa(mockhttp.DefaultOpenSearchPort))

	t.Run("Always succeeds", func(t *testing.T) {
		resp, err := NoOpHealthCheck(ctx, nil, serverURL) //nolint:bodyclose // NoOpHealthCheck returns nil response
		if err != nil {
	...
	t.Run("Works with cancelled context", func(t *testing.T) {
		...
		resp, err := NoOpHealthCheck(cancelCtx, nil, serverURL) //nolint:bodyclose // NoOpHealthCheck returns nil response
		if err != nil {
	...
	t.Run("Works with nil URL", func(t *testing.T) {
		resp, err := NoOpHealthCheck(ctx, nil, nil) //nolint:bodyclose // NoOpHealthCheck returns nil response
		if err != nil {
