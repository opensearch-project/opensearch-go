...
GOLANGCI_LINT_BUILD_TAGS := "integration core plugins plugin_security plugin_index_management plugin_ml_commons multinode"
...
test-all:  ## Run all tests with all build tags (unit + integration)
	...
	@$(MAKE) test-integ testintegtags=integration,core,plugins,plugin_security,plugin_index_management,plugin_ml_commons,multinode
...
test-race:  ## Run all tests with race detection enabled
	...
	@$(MAKE) test-integ race=true testintegtags=integration,core,plugins,plugin_security,plugin_index_management,plugin_ml_commons,multinode
