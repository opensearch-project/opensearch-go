...
func TestPathBuilders(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "IndicesActionPath/single_empty_index", build: func() (string, error) {
			return opensearch.IndicesActionPath{Indices: opensearch.Indices{""}, Action: "_search"}.Build()
		}, wantErr: true},
		{name: "IndicesActionPath/all_empty_indices", build: func() (string, error) {
			return opensearch.IndicesActionPath{Indices: opensearch.Indices{"", "", ""}, Action: "_search"}.Build()
		}, wantErr: true},
		{name: "IndicesActionPath/leading_empty", build: func() (string, error) {
			return opensearch.IndicesActionPath{Indices: opensearch.Indices{"", "i1"}, Action: "_search"}.Build()
		}, want: "/i1/_search"},
		{name: "IndicesActionPath/trailing_empty", build: func() (string, error) {
			return opensearch.IndicesActionPath{Indices: opensearch.Indices{"i1", ""}, Action: "_search"}.Build()
		}, want: "/i1/_search"},
		{name: "IndicesActionPath/middle_empty", build: func() (string, error) {
			return opensearch.IndicesActionPath{Indices: opensearch.Indices{"a", "", "b"}, Action: "_search"}.Build()
		}, want: "/a,b/_search"},
		...
		{name: "AliasPath/empty_only_indices", build: func() (string, error) {
			return opensearch.AliasPath{Indices: opensearch.Indices{"", ""}, Alias: "a1"}.Build()
		}, want: "/_alias/a1"},
		{name: "AliasPath/mixed_empty_indices", build: func() (string, error) {
			return opensearch.AliasPath{Indices: opensearch.Indices{"", "i1", ""}, Alias: "a1"}.Build()
		}, want: "/i1/_alias/a1"},
