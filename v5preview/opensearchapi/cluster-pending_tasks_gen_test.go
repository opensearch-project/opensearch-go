...
func TestClusterPendingTasksReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.ClusterPendingTasksReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestClusterPendingTasks_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cluster.PendingTasks(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cluster.PendingTasks(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
