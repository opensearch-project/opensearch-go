...
func TestSearch(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Search(t.Context(), &osapi.SearchReq{Index: []string{index}, BodyReader: strings.NewReader("{\"query\":{\"match_all\":{}}}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Search(t.Context(), &osapi.SearchReq{Index: []string{index}, BodyReader: strings.NewReader("{\"query\":{\"match_all\":{}}}")})
		require.Error(t, err)
