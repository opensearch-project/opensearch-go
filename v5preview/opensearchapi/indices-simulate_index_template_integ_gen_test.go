...
func TestIndicesSimulateIndexTemplate(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Indices.SimulateIndexTemplate(t.Context(), osapi.IndicesSimulateIndexTemplateReq{Name: name, BodyReader: strings.NewReader("{\"index_patterns\":[\"test-sim-*\"],\"template\":{\"settings\":{\"number_of_shards\":\"1\"}}}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Indices.SimulateIndexTemplate(t.Context(), osapi.IndicesSimulateIndexTemplateReq{Name: name, BodyReader: strings.NewReader("{\"index_patterns\":[\"test-sim-*\"],\"template\":{\"settings\":{\"number_of_shards\":\"1\"}}}")})
		require.Error(t, err)
