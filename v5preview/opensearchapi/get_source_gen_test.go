...
func TestGetSourceReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.GetSourceReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.GetSourceReq{Index: "test-index", ID: "test-id"},
			wantMethod: "GET",
...
func TestGetSource_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetSource(t.Context(), osapi.GetSourceReq{Index: "test", ID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetSource(t.Context(), osapi.GetSourceReq{Index: "test", ID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
