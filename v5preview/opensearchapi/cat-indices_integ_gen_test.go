...
func TestCatIndices(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Cat.Indices(t.Context(), &osapi.CatIndicesReq{Params: &osapi.CatIndicesParams{DebugParams: osapi.DebugParams{Format: "json"}}, Index: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Cat.Indices(t.Context(), &osapi.CatIndicesReq{Index: []string{index}})
		require.Error(t, err)
