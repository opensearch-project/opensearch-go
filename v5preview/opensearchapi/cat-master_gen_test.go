...
func TestCatMasterReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        opensearchapi.CatMasterReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestCatMaster_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.Master(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
