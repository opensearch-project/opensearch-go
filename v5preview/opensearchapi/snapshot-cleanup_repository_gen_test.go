...
func TestSnapshotCleanupRepositoryReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		name       string
		req        opensearchapi.SnapshotCleanupRepositoryReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestSnapshotCleanupRepository_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Snapshot.CleanupRepository(t.Context(), opensearchapi.SnapshotCleanupRepositoryReq{Repository: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Snapshot.CleanupRepository(t.Context(), opensearchapi.SnapshotCleanupRepositoryReq{Repository: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
