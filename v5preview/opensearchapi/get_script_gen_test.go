...
func TestGetScriptReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.GetScriptReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.GetScriptReq{ID: "test-id"},
			wantMethod: "GET",
...
func TestGetScript_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetScript(t.Context(), osapi.GetScriptReq{ID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetScript(t.Context(), osapi.GetScriptReq{ID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
