...
func TestExistsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.ExistsReq
		...
		},
		{
			...
			req:        osapi.ExistsReq{Index: "test-index", ID: "test-id"},
			wantMethod: "HEAD",
...
func TestExists_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Exists(t.Context(), osapi.ExistsReq{Index: "test", ID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Exists(t.Context(), osapi.ExistsReq{Index: "test", ID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
