...
func TestCatIndicesReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.CatIndicesReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			req:        osapi.CatIndicesReq{},
			wantMethod: "GET",
			wantPath:   "/_cat/indices",
			wantErr:    false,
		},
		{
			name:       "all path fields",
			req:        osapi.CatIndicesReq{Index: []string{"a", "b"}},
			wantMethod: "GET",
...
func TestCatIndices_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cat.Indices(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.Indices(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
