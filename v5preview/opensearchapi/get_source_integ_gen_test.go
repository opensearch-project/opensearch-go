...
func TestGetSource(t *testing.T) {
	...
	index := testutil.MustUniqueString(t, "test-get-source")
	docID := testutil.MustUniqueString(t, "test-get-source")
	t.Cleanup(func() {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetSource(t.Context(), osapi.GetSourceReq{Index: index, ID: docID})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetSource(t.Context(), osapi.GetSourceReq{Index: index, ID: docID})
		require.Error(t, err)
