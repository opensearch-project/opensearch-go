...
func TestGetScriptContextReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.GetScriptContextReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetScriptContext_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.GetScriptContext(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetScriptContext(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
