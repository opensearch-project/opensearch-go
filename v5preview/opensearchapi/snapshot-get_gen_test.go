...
func TestSnapshotGetReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		name       string
		req        opensearchapi.SnapshotGetReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestSnapshotGet_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Snapshot.Get(t.Context(), opensearchapi.SnapshotGetReq{Repository: "test", Snapshot: []string{"test"}})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Snapshot.Get(t.Context(), opensearchapi.SnapshotGetReq{Repository: "test", Snapshot: []string{"test"}})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
