...
func TestIndicesClearCacheReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.IndicesClearCacheReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			req:        osapi.IndicesClearCacheReq{},
			wantMethod: "POST",
			wantPath:   "/_cache/clear",
			wantErr:    false,
		},
		{
			name:       "all path fields",
			req:        osapi.IndicesClearCacheReq{Index: []string{"a", "b"}},
			wantMethod: "POST",
...
func TestIndicesClearCache_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Indices.ClearCache(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Indices.ClearCache(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
