...
func TestClusterReroute_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cluster.Reroute(t.Context(), &opensearchapi.ClusterRerouteReq{BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cluster.Reroute(t.Context(), &opensearchapi.ClusterRerouteReq{BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
