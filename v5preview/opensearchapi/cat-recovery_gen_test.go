...
func TestCatRecoveryReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.CatRecoveryReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			req:        osapi.CatRecoveryReq{},
			wantMethod: "GET",
			wantPath:   "/_cat/recovery",
			wantErr:    false,
		},
		{
			name:       "all path fields",
			req:        osapi.CatRecoveryReq{Index: []string{"a", "b"}},
			wantMethod: "GET",
...
func TestCatRecovery_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cat.Recovery(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.Recovery(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
