...
func TestDeletePITReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.DeletePITReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestDeletePIT_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.DeletePIT(t.Context(), &osapi.DeletePITReq{BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.DeletePIT(t.Context(), &osapi.DeletePITReq{BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
