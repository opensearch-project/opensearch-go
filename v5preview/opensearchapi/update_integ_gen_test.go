...
func TestUpdate(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Update(t.Context(), osapi.UpdateReq{Index: index, ID: docID, BodyReader: strings.NewReader("{\"doc\":{\"title\":\"updated\"}}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Update(t.Context(), osapi.UpdateReq{Index: index, ID: docID, BodyReader: strings.NewReader("{\"doc\":{\"title\":\"updated\"}}")})
		require.Error(t, err)
