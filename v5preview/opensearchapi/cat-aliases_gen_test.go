...
func TestCatAliasesReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        opensearchapi.CatAliasesReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			req:        opensearchapi.CatAliasesReq{},
			wantMethod: "GET",
			wantPath:   "/_cat/aliases",
			wantErr:    false,
		},
		{
			name:       "all path fields",
			req:        opensearchapi.CatAliasesReq{Name: []string{"a", "b"}},
			wantMethod: "GET",
			wantPath:   "/_cat/aliases/a,b",
			wantErr:    false,
		},
	}
...
func TestCatAliases_Roundtrip(t *testing.T) {
	t.Parallel()
