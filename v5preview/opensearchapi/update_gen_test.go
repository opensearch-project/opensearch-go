...
func TestUpdateReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			req:        osapi.UpdateReq{Index: "test-index", ID: "test-id"},
			wantMethod: "POST",
			wantPath:   "/test-index/_update/test-id",
			wantErr:    false,
		},
	}
...
func TestUpdate_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Update(t.Context(), osapi.UpdateReq{Index: "test", ID: "test", BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Update(t.Context(), osapi.UpdateReq{Index: "test", ID: "test", BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
