...
func TestCatShardsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.CatShardsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.CatShardsReq{Index: []string{"a", "b"}},
			wantMethod: "GET",
...
func TestCatShards_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cat.Shards(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.Shards(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
