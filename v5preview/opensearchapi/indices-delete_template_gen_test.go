...
func TestIndicesDeleteTemplateReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		name       string
		req        opensearchapi.IndicesDeleteTemplateReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestIndicesDeleteTemplate_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Indices.DeleteTemplate(t.Context(), opensearchapi.IndicesDeleteTemplateReq{Name: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Indices.DeleteTemplate(t.Context(), opensearchapi.IndicesDeleteTemplateReq{Name: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
