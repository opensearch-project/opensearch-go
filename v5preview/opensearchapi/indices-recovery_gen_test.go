...
func TestIndicesRecoveryReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.IndicesRecoveryReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.IndicesRecoveryReq{Index: []string{"a", "b"}},
			wantMethod: "GET",
...
func TestIndicesRecovery_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Indices.Recovery(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Indices.Recovery(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
