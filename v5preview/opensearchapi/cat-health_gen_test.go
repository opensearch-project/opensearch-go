...
func TestCatHealthReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        opensearchapi.CatHealthReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestCatHealth_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.Health(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
