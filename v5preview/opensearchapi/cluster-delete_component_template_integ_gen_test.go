...
func TestClusterDeleteComponentTemplate(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Cluster.DeleteComponentTemplate(t.Context(), opensearchapi.ClusterDeleteComponentTemplateReq{Name: name})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Cluster.DeleteComponentTemplate(t.Context(), opensearchapi.ClusterDeleteComponentTemplateReq{Name: name})
		require.Error(t, err)
