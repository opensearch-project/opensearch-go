...
func TestCatPendingTasksReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        opensearchapi.CatPendingTasksReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestCatPendingTasks_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.PendingTasks(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
