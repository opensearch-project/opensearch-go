...
func TestCatSegmentsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.CatSegmentsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.CatSegmentsReq{Index: []string{"a", "b"}},
			wantMethod: "GET",
...
func TestCatSegments_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cat.Segments(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.Segments(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
