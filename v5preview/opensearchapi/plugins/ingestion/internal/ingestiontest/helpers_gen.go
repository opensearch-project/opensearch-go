...
func NewClient(t *testing.T) (*ingestion.Client, error) {
	t.Helper()
	...
	return ingestion.NewClient(osClient), nil
}
...
func CreateFailingClient(t *testing.T) (*ingestion.Client, error) {
	t.Helper()
