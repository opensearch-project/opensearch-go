...
// CreateTenantReq represents the request for the security.create_tenant operation.
//
...
type CreateTenantReq struct {
	...
	Body *opensearchapi.SecurityCreateTenantParams
...
func (r CreateTenantReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.SecurityCreateTenantPath{
		Tenant: r.Tenant,
	}.Build()
	if err != nil {
		return nil, err
...
// CreateTenantParams represents query parameters for the CreateTenantReq.
type CreateTenantParams struct {
	opensearchapi.TimeoutParams
	opensearchapi.DebugParams
}

func (r CreateTenantParams) get() map[string]string {
	var params map[string]string
	set := func(k, v string) {
		if params == nil {
...
// CreateTenantResp represents the response for the security.create_tenant operation.
//
// Creates or replaces the specified tenant.
//
// Available: >= 1.0.0.
...
func (r CreateTenantResp) Inspect() Inspect {
...
func (r CreateTenantResp) RawBody() io.Reader {
