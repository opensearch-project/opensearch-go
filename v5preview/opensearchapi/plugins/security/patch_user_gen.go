...
// PatchUserReq represents the request for the security.patch_user operation.
//
...
func (r PatchUserReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.SecurityPatchUserPath{
		Username: r.Username,
	}.Build()
	if err != nil {
		return nil, err
...
// PatchUserParams represents query parameters for the PatchUserReq.
type PatchUserParams struct {
	osapi.TimeoutParams
	osapi.DebugParams
}

func (r PatchUserParams) get() map[string]string {
	var params map[string]string
	set := func(k, v string) {
		if params == nil {
...
// PatchUserResp represents the response for the security.patch_user operation.
//
// Updates individual attributes for an internal user.
//
// Available: >= 1.0.0.
...
func (r PatchUserResp) Inspect() Inspect {
...
func (r PatchUserResp) RawBody() io.Reader {
