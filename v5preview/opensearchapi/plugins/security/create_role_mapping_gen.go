...
type CreateRoleMappingReq struct {
...
func (r CreateRoleMappingReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.SecurityCreateRoleMappingPath{
		Role: r.Role,
	}.Build()
	if err != nil {
		return nil, err
...
// CreateRoleMappingResp represents the response for the security.create_role_mapping operation.
//
// Creates or replaces the specified role mapping.
//
// Available: >= 1.0.0.
//
// See: https://opensearch.org/docs/latest/security/access-control/api/#create-role-mapping
type CreateRoleMappingResp struct {
...
func (r CreateRoleMappingResp) Inspect() Inspect {
...
func (r CreateRoleMappingResp) RawBody() io.Reader {
