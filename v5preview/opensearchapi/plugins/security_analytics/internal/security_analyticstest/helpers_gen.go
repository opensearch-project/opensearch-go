...
package security_analyticstest
...
func NewClient(t *testing.T) (*security_analytics.Client, error) {
	t.Helper()
...
func CreateFailingClient(t *testing.T) (*security_analytics.Client, error) {
	t.Helper()
