...
func NewClient(t *testing.T) (*transforms.Client, error) {
	t.Helper()
	...
	return transforms.NewClient(osClient), nil
}
...
func CreateFailingClient(t *testing.T) (*transforms.Client, error) {
	t.Helper()
