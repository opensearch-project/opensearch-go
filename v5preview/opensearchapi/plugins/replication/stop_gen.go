...
// StopReq represents the request for the replication.stop operation.
//
...
func (r StopReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.ReplicationStopPath{
		Index: r.Index,
	}.Build()
	if err != nil {
		return nil, err
...
// StopResp represents the response for the replication.stop operation.
//
// Terminates the replication and converts the follower index to a standard index.
//
// Available: >= 1.1.0.
