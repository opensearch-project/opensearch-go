...
func NewClient(t *testing.T) (*insights.Client, error) {
	t.Helper()
	...
	return insights.NewClient(osClient), nil
}
...
func CreateFailingClient(t *testing.T) (*insights.Client, error) {
	t.Helper()
