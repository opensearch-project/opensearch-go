...
// CreateFeaturesetReq represents the request for the ltr.create_featureset operation.
//
...
//
// Available: >= 2.19.0.
type CreateFeaturesetReq struct {
	...
	Params *CreateFeaturesetParams
}

// GetRequest builds the HTTP request from the structured fields.
func (r CreateFeaturesetReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.LtrCreateFeaturesetPath{
		ID:    r.ID,
		Store: r.Store,
	}.Build()
	if err != nil {
...
// CreateFeaturesetParams represents query parameters for the CreateFeaturesetReq.
type CreateFeaturesetParams struct {
...
func (r CreateFeaturesetParams) get() map[string]string {
	var params map[string]string
	set := func(k, v string) {
		if params == nil {
...
// CreateFeaturesetResp represents the response for the ltr.create_featureset operation.
//
// Create or update a feature set in the default feature store.
//
// Available: >= 2.19.0.
type CreateFeaturesetResp struct {
...
func (r CreateFeaturesetResp) Inspect() Inspect {
...
func (r CreateFeaturesetResp) RawBody() io.Reader {
