...
func TestCatFielddataReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		name       string
		req        opensearchapi.CatFielddataReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        opensearchapi.CatFielddataReq{Fields: []string{"a", "b"}},
			wantMethod: "GET",
...
func TestCatFielddata_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.Fielddata(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
