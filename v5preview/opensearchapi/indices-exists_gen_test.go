...
func TestIndicesExists_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Indices.Exists(t.Context(), &osapi.IndicesExistsReq{Index: []string{"test"}})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Indices.Exists(t.Context(), &osapi.IndicesExistsReq{Index: []string{"test"}})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
