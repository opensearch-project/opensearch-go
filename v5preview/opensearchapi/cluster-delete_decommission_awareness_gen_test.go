...
func TestClusterDeleteDecommissionAwarenessReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.ClusterDeleteDecommissionAwarenessReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestClusterDeleteDecommissionAwareness_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cluster.DeleteDecommissionAwareness(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
