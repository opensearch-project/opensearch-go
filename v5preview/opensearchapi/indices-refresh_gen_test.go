...
func TestIndicesRefreshReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.IndicesRefreshReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.IndicesRefreshReq{Index: []string{"a", "b"}},
			wantMethod: "GET",
...
func TestIndicesRefresh_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Indices.Refresh(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Indices.Refresh(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
