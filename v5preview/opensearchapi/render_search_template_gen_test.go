...
func TestRenderSearchTemplateReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		name       string
		req        opensearchapi.RenderSearchTemplateReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        opensearchapi.RenderSearchTemplateReq{ID: "test-id"},
			wantMethod: "GET",
		...
		},
		{
			...
			req:        opensearchapi.RenderSearchTemplateReq{ID: "test", Body: &opensearchapi.RenderSearchTemplateBody{}},
			wantMethod: "POST",
