...
func TestCatClusterManagerReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.CatClusterManagerReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestCatClusterManager_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.ClusterManager(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
