...
func TestIndicesRolloverReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		name       string
		req        opensearchapi.IndicesRolloverReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestIndicesRollover_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Indices.Rollover(t.Context(), opensearchapi.IndicesRolloverReq{Alias: "test", BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Indices.Rollover(t.Context(), opensearchapi.IndicesRolloverReq{Alias: "test", BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
