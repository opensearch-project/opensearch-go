...
func TestIndicesDeleteAlias(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Indices.DeleteAlias(t.Context(), &osapi.IndicesDeleteAliasReq{Index: []string{index}, Name: []string{name}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Indices.DeleteAlias(t.Context(), &osapi.IndicesDeleteAliasReq{Index: []string{index}, Name: []string{name}})
		require.Error(t, err)
