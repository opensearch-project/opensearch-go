...
// IndicesGetResp represents the response for the IndicesGet operation.
...
func (r IndicesGetResp) RawBody() io.Reader {
...
// Get returns information about one or more indexes.
//
// GET /{index}
//
// Available: >= 1.0.0.
