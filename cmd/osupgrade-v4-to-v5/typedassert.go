...
func runTypedAssert(pass *analysis.Pass) (interface{}, error) {
...
func pickLiteralAndTarget(pass *analysis.Pass, x, y ast.Expr) (lit ast.Expr, target *types.Basic, ok bool) {
