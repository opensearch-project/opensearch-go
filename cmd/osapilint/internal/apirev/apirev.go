...
// Package apirev models the exported-struct surface (the "API revision") of one
// or more opensearchapi/opensearch packages at a given version, and derives the
// field-level delta between two versions.
//
// The migration linter is type-aware, not name-based: it must know, per struct,
