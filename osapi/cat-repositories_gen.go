...
// CatRepositoriesResp represents the response for the cat.repositories operation.
//
// Returns information about all snapshot repositories for a cluster.
//
// Available: >= 1.0.0.
...
// CatRepositoriesRecord is a typed component of the cat.repositories response.
