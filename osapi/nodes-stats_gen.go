...
// NodesStatsStats is a typed component of the nodes.stats response.
...
// NodesStatsAdaptiveSelection is a typed component of the nodes.stats response.
...
// NodesStatsShardAdmissionControl is a typed component of the nodes.stats response.
...
// NodesStatsUsage is a typed component of the nodes.stats response.
type NodesStatsUsage struct {
	Transport *NodesStatsTransportUsage `json:"transport,omitempty"`
}

// NodesStatsTransportUsage is a typed component of the nodes.stats response.
type NodesStatsTransportUsage struct {
	RejectionCount map[string]int64 `json:"rejection_count,omitempty"`
}

// NodesStatsBreaker is a typed component of the nodes.stats response.
...
// NodesStatsCache is a typed component of the nodes.stats response.
type NodesStatsCache struct {
}

// NodesStatsShardClusterManagerThrottling is a typed component of the nodes.stats response.
...
// NodesStatsShardClusterManagerThrottlingDetail is a typed component of the nodes.stats response.
...
// NodesStatsDiscovery is a typed component of the nodes.stats response.
...
// NodesStatsClusterStateQueue is a typed component of the nodes.stats response.
...
// NodesStatsClusterState is a typed component of the nodes.stats response.
type NodesStatsClusterState struct {
	Overall *NodesStatsClusterStateOverall `json:"overall,omitempty"`
}

// NodesStatsClusterStateOverall is a typed component of the nodes.stats response.
...
// NodesStatsPublishedClusterStates is a typed component of the nodes.stats response.
...
// NodesStatsFileSystem is a typed component of the nodes.stats response.
...
// NodesStatsDataPath is a typed component of the nodes.stats response.
...
// NodesStatsIo is a typed component of the nodes.stats response.
...
// NodesStatsIoStatDevice is a typed component of the nodes.stats response.
...
// NodesStatsFileSystemTotal is a typed component of the nodes.stats response.
...
// NodesStatsHTTP is a typed component of the nodes.stats response.
...
// NodesStatsIndexingPressure is a typed component of the nodes.stats response.
type NodesStatsIndexingPressure struct {
	Memory *NodesStatsIndexingPressureMemory `json:"memory,omitempty"`
}

// NodesStatsIndexingPressureMemory is a typed component of the nodes.stats response.
...
// NodesStatsPressureMemory is a typed component of the nodes.stats response.
...
// NodesStatsNodeIndices is a typed component of the nodes.stats response.
type NodesStatsNodeIndices struct {
}

// NodesStatsIngest is a typed component of the nodes.stats response.
...
// NodesStatsIngestTotal is a typed component of the nodes.stats response.
...
// NodesStatsKeyedProcessor is a typed component of the nodes.stats response.
type NodesStatsKeyedProcessor struct {
	Stats *NodesStatsProcessor `json:"stats,omitempty"`
	Type  *string              `json:"type,omitempty"`
}

// NodesStatsProcessor is a typed component of the nodes.stats response.
...
// NodesStatsJvm is a typed component of the nodes.stats response.
...
// NodesStatsNodeBufferPool is a typed component of the nodes.stats response.
...
// NodesStatsJvmClasses is a typed component of the nodes.stats response.
...
// NodesStatsGarbageCollector is a typed component of the nodes.stats response.
...
// NodesStatsGarbageCollectorTotal is a typed component of the nodes.stats response.
...
// NodesStatsJvmMemory is a typed component of the nodes.stats response.
...
// NodesStatsPool is a typed component of the nodes.stats response.
...
// NodesStatsLastGc is a typed component of the nodes.stats response.
...
// NodesStatsJvmThreads is a typed component of the nodes.stats response.
...
// NodesStatsOperatingSystem is a typed component of the nodes.stats response.
...
// NodesStatsCgroup is a typed component of the nodes.stats response.
...
// NodesStatsCgroupCpu is a typed component of the nodes.stats response.
...
// NodesStatsCgroupCpuStat is a typed component of the nodes.stats response.
...
// NodesStatsCgroupCpuAcct is a typed component of the nodes.stats response.
...
// NodesStatsCgroupMemory is a typed component of the nodes.stats response.
...
// NodesStatsOperatingSystemCpu is a typed component of the nodes.stats response.
...
// NodesStatsExtendedMemory is a typed component of the nodes.stats response.
type NodesStatsExtendedMemory struct {
}

// NodesStatsMemory is a typed component of the nodes.stats response.
type NodesStatsMemory struct {
}

// NodesStatsProcess is a typed component of the nodes.stats response.
...
// NodesStatsProcessCpu is a typed component of the nodes.stats response.
...
// NodesStatsProcessMemory is a typed component of the nodes.stats response.
...
// NodesStatsRemoteStore is a typed component of the nodes.stats response.
...
// NodesStatsShardResourceUsageDetail is a typed component of the nodes.stats response.
...
// NodesStatsShardResourceUsageIoUsageStats is a typed component of the nodes.stats response.
...
// NodesStatsScript is a typed component of the nodes.stats response.
type NodesStatsScript struct {
}

// NodesStatsScriptCache is a typed component of the nodes.stats response.
type NodesStatsScriptCache struct {
	Contexts []NodesStatsScriptContext `json:"contexts,omitempty"`
	Sum      NodesStatsScript          `json:"sum"`
}

// NodesStatsScriptContext is a typed component of the nodes.stats response.
type NodesStatsScriptContext struct {
}

// NodesStatsShardSearchBackpressure is a typed component of the nodes.stats response.
...
// NodesStatsShardSearchBackpressureTask is a typed component of the nodes.stats response.
...
// NodesStatsShardSearchBackpressureTaskCancellation is a typed component of the nodes.stats response.
...
// NodesStatsShardSearchBackpressureTaskResourceTracker is a typed component of the nodes.stats response.
...
// NodesStatsShardSearchBackpressureTaskResourceTrackerCpuUsageTracker is a typed component of the nodes.stats response.
...
// NodesStatsShardSearchBackpressureTaskResourceTrackerElapsedTimeTracker is a typed component of the nodes.stats response.
...
// NodesStatsShardSearchBackpressureTaskResourceTrackerHeapUsageTracker is a typed component of the nodes.stats response.
...
// NodesStatsShardSearchPipeline is a typed component of the nodes.stats response.
...
// NodesStatsShardSearchPipelinePerPipeline is a typed component of the nodes.stats response.
...
// NodesStatsShardSearchPipelineOperation is a typed component of the nodes.stats response.
...
// NodesStatsShardSearchPipelinePerPipelineProcessor is a typed component of the nodes.stats response.
...
// NodesStatsShardSegmentReplicationBackpressure is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressure is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShard is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShardIndexing is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShardLastSuccessfulTimestamp is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShardMemory is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShardMemoryDetails is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShardMemoryAllocation is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShardMemoryAllocationCurrent is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShardMemoryAllocationLimit is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShardRejection is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShardRejectionCoordinating is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressureRejectionsBreakup is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShardRejectionPrimary is a typed component of the nodes.stats response.
...
// NodesStatsShardIndexingPressurePerShardRejectionReplica is a typed component of the nodes.stats response.
...
// NodesStatsShardTaskCancellation is a typed component of the nodes.stats response.
...
// NodesStatsShardTaskCancellationDetail is a typed component of the nodes.stats response.
...
// NodesStatsThreadCount is a typed component of the nodes.stats response.
...
// NodesStatsTransport is a typed component of the nodes.stats response.
...
// NodesStatsShardWeightedRouting is a typed component of the nodes.stats response.
type NodesStatsShardWeightedRouting struct {
	Stats *NodesStatsShardWeightedRoutingDetail `json:"stats,omitempty"`
}

// NodesStatsShardWeightedRoutingDetail is a typed component of the nodes.stats response.
...
func (u *NodesStatsIP) String() string { return u.stringVal }

// Array returns the []string branch value.
func (u *NodesStatsIP) Array() []string { return u.arrayVal }
