...
func TestIngestGetPipelineReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.IngestGetPipelineReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.IngestGetPipelineReq{ID: "test-id"},
			wantMethod: "GET",
...
func TestIngestGetPipeline_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Ingest.GetPipeline(t.Context(), osapi.IngestGetPipelineReq{})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
