...
func TestClusterPostVotingConfigExclusionsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.ClusterPostVotingConfigExclusionsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestClusterPostVotingConfigExclusions_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cluster.PostVotingConfigExclusions(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cluster.PostVotingConfigExclusions(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
