...
func TestCatCountReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.CatCountReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.CatCountReq{Index: []string{"a", "b"}},
			wantMethod: "GET",
...
func TestCatCount_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.Count(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
