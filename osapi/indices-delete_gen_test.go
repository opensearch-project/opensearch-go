...
func TestIndicesDeleteReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		...
		},
		{
			...
			req:        osapi.IndicesDeleteReq{Index: []string{"a", "b"}},
			wantMethod: "DELETE",
			wantPath:   "/a,b",
			wantErr:    false,
		},
...
func TestIndicesDelete_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Indices.Delete(t.Context(), &osapi.IndicesDeleteReq{Index: []string{"test"}})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Indices.Delete(t.Context(), &osapi.IndicesDeleteReq{Index: []string{"test"}})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
