...
type Response interface {
	Inspect() osapi.Inspect
}

// CreateFailingClient returns an osapi.Client that always returns 400 with an empty object as body.
func CreateFailingClient(t *testing.T) (*osapi.Client, error) {
	t.Helper()
...
// VerifyInspect validates the returned osapi.Inspect type
