...
func TestMget(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Mget(t.Context(), osapi.MgetReq{Index: index, Body: strings.NewReader("{\"docs\":[{\"_index\":\"" + index + "\",\"_id\":\"" + docID + "\"}]}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Mget(t.Context(), osapi.MgetReq{Index: index, Body: strings.NewReader("{\"docs\":[{\"_index\":\"" + index + "\",\"_id\":\"" + docID + "\"}]}")})
		require.Error(t, err)
