...
func TestSearchShards(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.SearchShards(t.Context(), &osapi.SearchShardsReq{Index: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.SearchShards(t.Context(), &osapi.SearchShardsReq{Index: []string{index}})
		require.Error(t, err)
