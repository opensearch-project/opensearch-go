...
func TestIndicesUpdateAliases(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Indices.UpdateAliases(t.Context(), &osapi.IndicesUpdateAliasesReq{Body: strings.NewReader("{\"actions\":[{\"add\":{\"index\":\"" + index + "\",\"alias\":\"test-alias-2\"}}]}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Indices.UpdateAliases(t.Context(), &osapi.IndicesUpdateAliasesReq{Body: strings.NewReader("{\"actions\":[{\"add\":{\"index\":\"" + index + "\",\"alias\":\"test-alias-2\"}}]}")})
		require.Error(t, err)
