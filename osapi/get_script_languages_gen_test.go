...
func TestGetScriptLanguagesReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.GetScriptLanguagesReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestGetScriptLanguages_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.GetScriptLanguages(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
