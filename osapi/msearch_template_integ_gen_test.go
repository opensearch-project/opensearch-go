...
func TestMsearchTemplate(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.MsearchTemplate(t.Context(), &osapi.MsearchTemplateReq{Index: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.MsearchTemplate(t.Context(), &osapi.MsearchTemplateReq{Index: []string{index}})
		require.Error(t, err)
