...
func TestIndicesRollover(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Indices.Rollover(t.Context(), osapi.IndicesRolloverReq{Alias: name, Body: strings.NewReader("{\"conditions\":{\"max_docs\":1000}}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Indices.Rollover(t.Context(), osapi.IndicesRolloverReq{Alias: name, Body: strings.NewReader("{\"conditions\":{\"max_docs\":1000}}")})
		require.Error(t, err)
