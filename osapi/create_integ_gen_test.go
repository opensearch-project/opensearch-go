...
func TestCreate(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Create(t.Context(), osapi.CreateReq{Index: index, ID: "test-doc-1", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Create(t.Context(), osapi.CreateReq{Index: index, ID: "test-doc-1", Body: strings.NewReader("{}")})
		require.Error(t, err)
