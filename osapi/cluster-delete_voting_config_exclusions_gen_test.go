...
func TestClusterDeleteVotingConfigExclusionsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.ClusterDeleteVotingConfigExclusionsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestClusterDeleteVotingConfigExclusions_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cluster.DeleteVotingConfigExclusions(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
