...
func TestGetSource(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetSource(t.Context(), osapi.GetSourceReq{Index: index, ID: "test-doc-1"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetSource(t.Context(), osapi.GetSourceReq{Index: index, ID: "test-doc-1"})
		require.Error(t, err)
