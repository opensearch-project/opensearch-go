...
func TestMtermvectors(t *testing.T) {
	...
	index := testutil.MustUniqueString(t, "test-mtermvectors")
	t.Cleanup(func() {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Mtermvectors(t.Context(), osapi.MtermvectorsReq{Index: index})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Mtermvectors(t.Context(), osapi.MtermvectorsReq{Index: index})
		require.Error(t, err)
