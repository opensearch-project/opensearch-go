...
func (r CatMasterReq) GetRequest() (*http.Request, error) {
	path, err := ospath.CatMasterPath{}.Build()
	if err != nil {
		return nil, err
	}
...
// CatMasterResp represents the response for the cat.master operation.
//
// Returns information about the cluster-manager node.
//
// Deprecated: since 2.0.0. Available >= 1.0.0. To promote inclusive
...
// CatMasterRecord is a typed component of the cat.master response.
