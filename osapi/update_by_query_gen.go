...
func (r UpdateByQueryParams) get() map[string]string {
	params := make(map[string]string, 34)
...
// UpdateByQueryResp represents the response for the update_by_query operation.
//
// Performs an update on every document in the index without changing the source,
// for example to pick up a mapping change.
//
...
// UpdateByQueryResponseBodyObject is a typed component of the update_by_query response.
type UpdateByQueryResponseBodyObject struct {
