...
func TestRankEvalReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			req:        osapi.RankEvalReq{Index: []string{"x"}, Body: &osapi.RankEvalBody{}},
			wantMethod: "POST",
...
func TestRankEval_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.RankEval(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.RankEval(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
