...
func TestIndicesPutAlias(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Indices.PutAlias(t.Context(), osapi.IndicesPutAliasReq{Index: []string{index}, Name: name, Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Indices.PutAlias(t.Context(), osapi.IndicesPutAliasReq{Index: []string{index}, Name: name, Body: strings.NewReader("{}")})
		require.Error(t, err)
