	...
	t.Run("put and get settings", func(t *testing.T) {
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				putResp, err := client.Indices.PutSettings(t.Context(), &osapi.IndicesPutSettingsReq{
					Index:      []string{index},
				...
				getResp, err := client.Indices.GetSettings(t.Context(), &osapi.IndicesGetSettingsReq{
					Index: []string{index},
				})
				require.NoError(t, err)
...
func TestManual_IndicesMapping(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			putResp, err := client.Indices.PutMapping(t.Context(), &osapi.IndicesPutMappingReq{
				Index:      []string{index},
	...
	t.Run("get mapping", func(t *testing.T) {
		resp, err := client.Indices.GetMapping(t.Context(), &osapi.IndicesGetMappingReq{
			Index: []string{index},
		})
		require.NoError(t, err)
