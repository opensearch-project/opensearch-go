...
func TestIndicesUpgradeReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.IndicesUpgradeReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.IndicesUpgradeReq{Index: []string{"a", "b"}},
			wantMethod: "POST",
...
func TestIndicesUpgrade_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Indices.Upgrade(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Indices.Upgrade(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
