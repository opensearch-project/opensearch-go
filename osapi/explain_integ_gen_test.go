...
func TestExplain(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Explain(t.Context(), osapi.ExplainReq{Index: index, ID: "test-doc-1"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Explain(t.Context(), osapi.ExplainReq{Index: index, ID: "test-doc-1"})
		require.Error(t, err)
