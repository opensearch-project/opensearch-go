...
func TestCatNodeattrsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.CatNodeattrsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestCatNodeattrs_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cat.Nodeattrs(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cat.Nodeattrs(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
