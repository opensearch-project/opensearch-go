...
func TestIndicesStats(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Indices.Stats(t.Context(), &osapi.IndicesStatsReq{Index: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Indices.Stats(t.Context(), &osapi.IndicesStatsReq{Index: []string{index}})
		require.Error(t, err)
