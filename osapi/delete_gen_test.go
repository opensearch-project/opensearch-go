...
func TestDeleteReq_GetRequest(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			req:        osapi.DeleteReq{Index: "test-index", ID: "test-id"},
			wantMethod: "DELETE",
...
func TestDelete_Roundtrip(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Delete(t.Context(), osapi.DeleteReq{Index: "test", ID: "test"})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Delete(t.Context(), osapi.DeleteReq{Index: "test", ID: "test"})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
