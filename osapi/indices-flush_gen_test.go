...
func TestIndicesFlushReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.IndicesFlushReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.IndicesFlushReq{Index: []string{"a", "b"}},
			wantMethod: "GET",
			wantPath:   "/a,b/_flush",
			wantErr:    false,
		},
...
func TestIndicesFlush_Roundtrip(t *testing.T) {
	t.Parallel()
