...
func TestSearchTemplate(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.SearchTemplate(t.Context(), &osapi.SearchTemplateReq{Index: []string{index}, Body: strings.NewReader("{\"source\":\"{\\\"query\\\":{\\\"match_all\\\":{}}}\",\"params\":{}}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.SearchTemplate(t.Context(), &osapi.SearchTemplateReq{Index: []string{index}, Body: strings.NewReader("{\"source\":\"{\\\"query\\\":{\\\"match_all\\\":{}}}\",\"params\":{}}")})
		require.Error(t, err)
