...
func TestIndicesAddBlock(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Indices.AddBlock(t.Context(), osapi.IndicesAddBlockReq{Index: []string{index}, Block: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Indices.AddBlock(t.Context(), osapi.IndicesAddBlockReq{Index: []string{index}, Block: "test-value"})
		require.Error(t, err)
