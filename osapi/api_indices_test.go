...
func TestManual_IndicesCreate(t *testing.T) {
	...
	t.Run("create and verify", func(t *testing.T) {
		resp, err := client.Indices.Create(t.Context(), osapi.IndicesCreateReq{Index: index})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Indices.Create(t.Context(), osapi.IndicesCreateReq{Index: index})
		require.Error(t, err)
...
func TestManual_IndicesExists(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			resp, err := client.Indices.Exists(t.Context(), &osapi.IndicesExistsReq{Index: tt.index})
			if tt.exists {
				require.NoError(t, err)
...
func TestManual_IndicesDelete(t *testing.T) {
	...
	t.Run("delete existing", func(t *testing.T) {
		resp, err := client.Indices.Delete(t.Context(), &osapi.IndicesDeleteReq{Index: []string{index}})
		require.NoError(t, err)
		require.True(t, resp.Acknowledged)
		testutil.CompareRawJSONwithParsedJSON(t, resp, resp.Inspect().Response)
	})
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Indices.Delete(t.Context(), &osapi.IndicesDeleteReq{Index: []string{index}})
		require.Error(t, err)
		require.NotNil(t, res)
		osapitest.VerifyInspect(t, res.Inspect())
	})
...
func TestManual_Index(t *testing.T) {
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Index(t.Context(), osapi.IndexReq{
			Index: index,
