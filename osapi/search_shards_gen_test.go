...
func TestSearchShardsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.SearchShardsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		{
			...
			req:        osapi.SearchShardsReq{},
			wantMethod: "GET",
			wantPath:   "/_search_shards",
			wantErr:    false,
		},
		{
			name:       "all path fields",
			req:        osapi.SearchShardsReq{Index: []string{"a", "b"}},
			wantMethod: "GET",
		...
		},
		{
			...
			req:        osapi.SearchShardsReq{Index: []string{"x"}, Body: &osapi.SearchShardsBody{}},
			wantMethod: "POST",
...
func TestSearchShards_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.SearchShards(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
