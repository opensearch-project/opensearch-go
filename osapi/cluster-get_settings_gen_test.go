...
func TestClusterGetSettingsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.ClusterGetSettingsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestClusterGetSettings_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cluster.GetSettings(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cluster.GetSettings(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
