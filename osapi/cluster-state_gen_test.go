...
func TestClusterStateReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.ClusterStateReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.ClusterStateReq{Metric: []string{"a", "b"}, Index: []string{"a", "b"}},
			wantMethod: "GET",
...
func TestClusterState_Roundtrip(t *testing.T) {
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cluster.State(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
