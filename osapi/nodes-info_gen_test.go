...
func TestNodesInfoReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.NodesInfoReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.NodesInfoReq{NodeID: []string{"a", "b"}, Metric: []string{"a", "b"}},
			wantMethod: "GET",
...
func TestNodesInfo_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Nodes.Info(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
