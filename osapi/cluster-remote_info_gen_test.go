...
func TestClusterRemoteInfoReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.ClusterRemoteInfoReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestClusterRemoteInfo_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cluster.RemoteInfo(t.Context(), nil)
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cluster.RemoteInfo(t.Context(), nil)
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
