...
func TestIndicesForcemerge(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Indices.Forcemerge(t.Context(), &osapi.IndicesForcemergeReq{Index: []string{index}})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Indices.Forcemerge(t.Context(), &osapi.IndicesForcemergeReq{Index: []string{index}})
		require.Error(t, err)
