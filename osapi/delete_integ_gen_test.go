...
func TestDelete(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Delete(t.Context(), osapi.DeleteReq{Index: index, ID: "test-doc-1"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Delete(t.Context(), osapi.DeleteReq{Index: index, ID: "test-doc-1"})
		require.Error(t, err)
