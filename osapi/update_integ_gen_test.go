...
func TestUpdate(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.Update(t.Context(), osapi.UpdateReq{Index: index, ID: "test-doc-1", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.Update(t.Context(), osapi.UpdateReq{Index: index, ID: "test-doc-1", Body: strings.NewReader("{}")})
		require.Error(t, err)
