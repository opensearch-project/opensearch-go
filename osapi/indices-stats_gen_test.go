...
func TestIndicesStatsReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.IndicesStatsReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
		...
		},
		{
			...
			req:        osapi.IndicesStatsReq{Metric: []string{"a", "b"}, Index: []string{"a", "b"}},
			wantMethod: "GET",
...
func TestIndicesStats_Roundtrip(t *testing.T) {
	t.Parallel()
