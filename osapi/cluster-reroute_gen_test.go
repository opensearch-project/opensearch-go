...
func TestClusterRerouteReq_GetRequest(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name       string
		req        osapi.ClusterRerouteReq
		wantMethod string
		wantPath   string
		wantErr    bool
	}{
...
func TestClusterReroute_Roundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		resp, err := client.Cluster.Reroute(t.Context(), &osapi.ClusterRerouteReq{BodyReader: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("error", func(t *testing.T) {
		...
		resp, err := errClient.Cluster.Reroute(t.Context(), &osapi.ClusterRerouteReq{BodyReader: strings.NewReader("{}")})
		require.Error(t, err)
		require.NotNil(t, resp)
	})
}
