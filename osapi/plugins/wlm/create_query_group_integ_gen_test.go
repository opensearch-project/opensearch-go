...
func TestCreateQueryGroup(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.CreateQueryGroup(t.Context(), &wlm.CreateQueryGroupReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.CreateQueryGroup(t.Context(), &wlm.CreateQueryGroupReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
