...
func TestDeleteConfig(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteConfig(t.Context(), notifications.DeleteConfigReq{ConfigID: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteConfig(t.Context(), notifications.DeleteConfigReq{ConfigID: "test-value"})
		require.Error(t, err)
