...
func TestCreateConfig(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.CreateConfig(t.Context(), &notifications.CreateConfigReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.CreateConfig(t.Context(), &notifications.CreateConfigReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
