...
func TestGetConfig(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetConfig(t.Context(), notifications.GetConfigReq{ConfigID: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetConfig(t.Context(), notifications.GetConfigReq{ConfigID: "test-value"})
		require.Error(t, err)
