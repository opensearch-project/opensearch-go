...
func TestDatasourcesUpdate(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DatasourcesUpdate(t.Context(), &query.DatasourcesUpdateReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DatasourcesUpdate(t.Context(), &query.DatasourcesUpdateReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
