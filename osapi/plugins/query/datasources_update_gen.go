...
//
// Available: >= 2.7.0.
type DatasourcesUpdateReq struct {
...
func (r DatasourcesUpdateReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.QueryDatasourcesUpdatePath{}.Build()
	if err != nil {
		return nil, err
	}
...
// DatasourcesUpdateResp represents the response for the DatasourcesUpdate operation.
// The response body has a dynamic schema and is captured as raw JSON.
//
// Updates an existing query data source.
type DatasourcesUpdateResp struct {
...
func (r *DatasourcesUpdateResp) UnmarshalJSON(b []byte) error {
...
func (r DatasourcesUpdateResp) MarshalJSON() ([]byte, error) {
	if r.Body == nil {
...
func (r DatasourcesUpdateResp) Inspect() Inspect {
...
func (r DatasourcesUpdateResp) RawBody() io.Reader {
