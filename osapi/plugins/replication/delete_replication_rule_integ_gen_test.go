...
func TestDeleteReplicationRule(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteReplicationRule(t.Context(), &replication.DeleteReplicationRuleReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteReplicationRule(t.Context(), &replication.DeleteReplicationRuleReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
