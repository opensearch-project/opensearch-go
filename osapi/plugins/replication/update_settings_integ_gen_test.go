...
func TestUpdateSettings(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.UpdateSettings(t.Context(), replication.UpdateSettingsReq{Index: index, Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.UpdateSettings(t.Context(), replication.UpdateSettingsReq{Index: index, Body: strings.NewReader("{}")})
		require.Error(t, err)
