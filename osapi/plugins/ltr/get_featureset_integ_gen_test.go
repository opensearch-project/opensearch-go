...
func TestGetFeatureset(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetFeatureset(t.Context(), ltr.GetFeaturesetReq{Store: name, ID: docID})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetFeatureset(t.Context(), ltr.GetFeaturesetReq{Store: name, ID: docID})
		require.Error(t, err)
