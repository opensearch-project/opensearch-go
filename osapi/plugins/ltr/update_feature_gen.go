...
// UpdateFeatureReq represents the request for the ltr.update_feature operation.
//
...
func (r UpdateFeatureReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.LtrUpdateFeaturePath{
		ID:    r.ID,
		Store: r.Store,
	}.Build()
	if err != nil {
...
// UpdateFeatureParams represents query parameters for the UpdateFeatureReq.
...
func (r UpdateFeatureParams) get() map[string]string {
	var params map[string]string
	set := func(k, v string) {
		if params == nil {
...
// UpdateFeatureResp represents the response for the ltr.update_feature operation.
//
// Update a feature in the default feature store.
//
// Available: >= 2.19.0.
...
func (r UpdateFeatureResp) Inspect() Inspect {
...
func (r UpdateFeatureResp) RawBody() io.Reader {
