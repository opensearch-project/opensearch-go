...
func TestDeleteFeature(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteFeature(t.Context(), ltr.DeleteFeatureReq{Store: name, ID: docID})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteFeature(t.Context(), ltr.DeleteFeatureReq{Store: name, ID: docID})
		require.Error(t, err)
