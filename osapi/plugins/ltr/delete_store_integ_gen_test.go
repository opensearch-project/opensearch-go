...
func TestDeleteStore(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteStore(t.Context(), ltr.DeleteStoreReq{Store: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteStore(t.Context(), ltr.DeleteStoreReq{Store: "test-value"})
		require.Error(t, err)
