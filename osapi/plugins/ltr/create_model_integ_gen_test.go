...
func TestCreateModel(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.CreateModel(t.Context(), ltr.CreateModelReq{Store: name, ID: docID, Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.CreateModel(t.Context(), ltr.CreateModelReq{Store: name, ID: docID, Body: strings.NewReader("{}")})
		require.Error(t, err)
