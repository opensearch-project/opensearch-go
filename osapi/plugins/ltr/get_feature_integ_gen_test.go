...
func TestGetFeature(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetFeature(t.Context(), ltr.GetFeatureReq{Store: name, ID: docID})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetFeature(t.Context(), ltr.GetFeatureReq{Store: name, ID: docID})
		require.Error(t, err)
