...
func TestDeleteModel(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteModel(t.Context(), ltr.DeleteModelReq{Store: name, ID: docID})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteModel(t.Context(), ltr.DeleteModelReq{Store: name, ID: docID})
		require.Error(t, err)
