...
func TestUpdateFeature(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.UpdateFeature(t.Context(), ltr.UpdateFeatureReq{Store: name, ID: docID, Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.UpdateFeature(t.Context(), ltr.UpdateFeatureReq{Store: name, ID: docID, Body: strings.NewReader("{}")})
		require.Error(t, err)
