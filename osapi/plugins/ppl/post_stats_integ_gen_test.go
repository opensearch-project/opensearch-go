...
func TestPostStats(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.PostStats(t.Context(), &ppl.PostStatsReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.PostStats(t.Context(), &ppl.PostStatsReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
