...
// PostStatsReq represents the request for the ppl.post_stats operation.
//
...
func (r PostStatsReq) GetRequest(method string) (*http.Request, error) {
	path, err := ospath.PplPostStatsPath{}.Build()
	if err != nil {
		return nil, err
	}
...
func (r PostStatsParams) get() map[string]string {
	var params map[string]string
	set := func(k, v string) {
		if params == nil {
...
// PostStatsResp represents the response for the ppl.post_stats operation.
//
// Retrieves filtered performance metrics for the PPL plugin.
//
// Available: >= 1.0.0.
...
func (r PostStatsResp) Inspect() Inspect {
...
func (r PostStatsResp) RawBody() io.Reader {
