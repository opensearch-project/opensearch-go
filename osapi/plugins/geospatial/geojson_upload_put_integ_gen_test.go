...
func TestGeojsonUploadPut(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GeojsonUploadPut(t.Context(), &geospatial.GeojsonUploadPutReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GeojsonUploadPut(t.Context(), &geospatial.GeojsonUploadPutReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
