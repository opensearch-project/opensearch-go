...
func TestPutIp2geoDatasource(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.PutIp2geoDatasource(t.Context(), geospatial.PutIp2geoDatasourceReq{Name: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.PutIp2geoDatasource(t.Context(), geospatial.PutIp2geoDatasourceReq{Name: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
