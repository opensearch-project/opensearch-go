...
func TestDeleteIp2geoDatasource(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteIp2geoDatasource(t.Context(), geospatial.DeleteIp2geoDatasourceReq{Name: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteIp2geoDatasource(t.Context(), geospatial.DeleteIp2geoDatasourceReq{Name: "test-value"})
		require.Error(t, err)
