...
func TestGetUserLegacy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetUserLegacy(t.Context(), security.GetUserLegacyReq{Username: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetUserLegacy(t.Context(), security.GetUserLegacyReq{Username: "test-value"})
		require.Error(t, err)
