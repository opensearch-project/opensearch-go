...
func TestPatchTenant(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.PatchTenant(t.Context(), security.PatchTenantReq{Tenant: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.PatchTenant(t.Context(), security.PatchTenantReq{Tenant: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
