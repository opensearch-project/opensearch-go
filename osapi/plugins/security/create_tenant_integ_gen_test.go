...
func TestCreateTenant(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.CreateTenant(t.Context(), security.CreateTenantReq{Tenant: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.CreateTenant(t.Context(), security.CreateTenantReq{Tenant: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
