...
func TestConfigUpgradePerform(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.ConfigUpgradePerform(t.Context(), &security.ConfigUpgradePerformReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.ConfigUpgradePerform(t.Context(), &security.ConfigUpgradePerformReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
