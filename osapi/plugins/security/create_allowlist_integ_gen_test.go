...
func TestCreateAllowlist(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.CreateAllowlist(t.Context(), &security.CreateAllowlistReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.CreateAllowlist(t.Context(), &security.CreateAllowlistReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
