...
func TestDeleteUserLegacy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteUserLegacy(t.Context(), security.DeleteUserLegacyReq{Username: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteUserLegacy(t.Context(), security.DeleteUserLegacyReq{Username: "test-value"})
		require.Error(t, err)
