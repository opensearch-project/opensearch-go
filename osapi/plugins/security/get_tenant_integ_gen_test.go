...
func TestGetTenant(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetTenant(t.Context(), security.GetTenantReq{Tenant: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetTenant(t.Context(), security.GetTenantReq{Tenant: "test-value"})
		require.Error(t, err)
