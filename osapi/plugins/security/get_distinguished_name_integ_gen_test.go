...
func TestGetDistinguishedName(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetDistinguishedName(t.Context(), security.GetDistinguishedNameReq{ClusterName: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetDistinguishedName(t.Context(), security.GetDistinguishedNameReq{ClusterName: "test-value"})
		require.Error(t, err)
