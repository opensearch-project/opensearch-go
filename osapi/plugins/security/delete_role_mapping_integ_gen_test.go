...
func TestDeleteRoleMapping(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteRoleMapping(t.Context(), security.DeleteRoleMappingReq{Role: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteRoleMapping(t.Context(), security.DeleteRoleMappingReq{Role: "test-value"})
		require.Error(t, err)
