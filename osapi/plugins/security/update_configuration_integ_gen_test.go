...
func TestUpdateConfiguration(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.UpdateConfiguration(t.Context(), &security.UpdateConfigurationReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.UpdateConfiguration(t.Context(), &security.UpdateConfigurationReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
