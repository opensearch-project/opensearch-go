...
func TestDeleteRole(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteRole(t.Context(), security.DeleteRoleReq{Role: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteRole(t.Context(), security.DeleteRoleReq{Role: "test-value"})
		require.Error(t, err)
