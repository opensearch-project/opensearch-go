...
func TestCreateUserLegacy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.CreateUserLegacy(t.Context(), security.CreateUserLegacyReq{Username: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.CreateUserLegacy(t.Context(), security.CreateUserLegacyReq{Username: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
