...
func TestPatchRole(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.PatchRole(t.Context(), security.PatchRoleReq{Role: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.PatchRole(t.Context(), security.PatchRoleReq{Role: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
