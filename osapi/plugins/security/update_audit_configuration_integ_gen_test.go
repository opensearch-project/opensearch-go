...
func TestUpdateAuditConfiguration(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.UpdateAuditConfiguration(t.Context(), &security.UpdateAuditConfigurationReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.UpdateAuditConfiguration(t.Context(), &security.UpdateAuditConfigurationReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
