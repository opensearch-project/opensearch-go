...
func (r GetUserReq) GetRequest(method string) (*http.Request, error) {
...
// GetUserResp represents the response for the GetUser operation.
...
func (r *GetUserResp) UnmarshalJSON(b []byte) error {
...
func (r GetUserResp) RawBody() io.Reader {
