...
func TestGetUser(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetUser(t.Context(), security.GetUserReq{Username: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetUser(t.Context(), security.GetUserReq{Username: "test-value"})
		require.Error(t, err)
