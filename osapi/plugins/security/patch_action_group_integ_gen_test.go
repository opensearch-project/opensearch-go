...
func TestPatchActionGroup(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.PatchActionGroup(t.Context(), security.PatchActionGroupReq{ActionGroup: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.PatchActionGroup(t.Context(), security.PatchActionGroupReq{ActionGroup: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
