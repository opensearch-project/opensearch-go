...
func TestGetActionGroup(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetActionGroup(t.Context(), security.GetActionGroupReq{ActionGroup: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetActionGroup(t.Context(), security.GetActionGroupReq{ActionGroup: "test-value"})
		require.Error(t, err)
