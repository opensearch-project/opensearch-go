...
func TestDeleteUser(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteUser(t.Context(), security.DeleteUserReq{Username: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteUser(t.Context(), security.DeleteUserReq{Username: "test-value"})
		require.Error(t, err)
