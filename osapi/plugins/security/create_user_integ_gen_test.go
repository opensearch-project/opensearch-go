...
func TestCreateUser(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.CreateUser(t.Context(), security.CreateUserReq{Username: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.CreateUser(t.Context(), security.CreateUserReq{Username: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
