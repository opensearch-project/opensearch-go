...
func TestCreateActionGroup(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.CreateActionGroup(t.Context(), security.CreateActionGroupReq{ActionGroup: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.CreateActionGroup(t.Context(), security.CreateActionGroupReq{ActionGroup: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
