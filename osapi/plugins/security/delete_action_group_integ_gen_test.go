...
func TestDeleteActionGroup(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteActionGroup(t.Context(), security.DeleteActionGroupReq{ActionGroup: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteActionGroup(t.Context(), security.DeleteActionGroupReq{ActionGroup: "test-value"})
		require.Error(t, err)
