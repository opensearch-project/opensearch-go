...
func TestCreateRole(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.CreateRole(t.Context(), security.CreateRoleReq{Role: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.CreateRole(t.Context(), security.CreateRoleReq{Role: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
