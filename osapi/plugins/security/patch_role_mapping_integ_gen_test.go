...
func TestPatchRoleMapping(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.PatchRoleMapping(t.Context(), security.PatchRoleMappingReq{Role: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.PatchRoleMapping(t.Context(), security.PatchRoleMappingReq{Role: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
