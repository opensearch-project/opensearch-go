...
func TestDeleteTenant(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeleteTenant(t.Context(), security.DeleteTenantReq{Tenant: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeleteTenant(t.Context(), security.DeleteTenantReq{Tenant: "test-value"})
		require.Error(t, err)
