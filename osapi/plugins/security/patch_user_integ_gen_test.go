...
func TestPatchUser(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.PatchUser(t.Context(), security.PatchUserReq{Username: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.PatchUser(t.Context(), security.PatchUserReq{Username: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
