...
func TestChangePassword(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.ChangePassword(t.Context(), &security.ChangePasswordReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.ChangePassword(t.Context(), &security.ChangePasswordReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
