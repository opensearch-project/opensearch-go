...
func TestPostScheduledExperiments(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.PostScheduledExperiments(t.Context(), &search_relevance.PostScheduledExperimentsReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.PostScheduledExperiments(t.Context(), &search_relevance.PostScheduledExperimentsReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
