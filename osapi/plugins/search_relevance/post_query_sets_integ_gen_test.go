...
func TestPostQuerySets(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.PostQuerySets(t.Context(), &search_relevance.PostQuerySetsReq{Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.PostQuerySets(t.Context(), &search_relevance.PostQuerySetsReq{Body: strings.NewReader("{}")})
		require.Error(t, err)
