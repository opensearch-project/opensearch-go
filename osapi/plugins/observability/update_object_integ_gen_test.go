...
func TestUpdateObject(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.UpdateObject(t.Context(), observability.UpdateObjectReq{ObjectID: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.UpdateObject(t.Context(), observability.UpdateObjectReq{ObjectID: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
