...
func TestGetObject(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetObject(t.Context(), observability.GetObjectReq{ObjectID: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetObject(t.Context(), observability.GetObjectReq{ObjectID: "test-value"})
		require.Error(t, err)
