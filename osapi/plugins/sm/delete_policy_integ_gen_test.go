...
func TestDeletePolicy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeletePolicy(t.Context(), sm.DeletePolicyReq{PolicyName: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeletePolicy(t.Context(), sm.DeletePolicyReq{PolicyName: "test-value"})
		require.Error(t, err)
