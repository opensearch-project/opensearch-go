...
func TestExplainPolicy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.ExplainPolicy(t.Context(), sm.ExplainPolicyReq{PolicyName: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.ExplainPolicy(t.Context(), sm.ExplainPolicyReq{PolicyName: "test-value"})
		require.Error(t, err)
