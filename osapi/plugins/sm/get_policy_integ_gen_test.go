...
func TestGetPolicy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.GetPolicy(t.Context(), sm.GetPolicyReq{PolicyName: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.GetPolicy(t.Context(), sm.GetPolicyReq{PolicyName: "test-value"})
		require.Error(t, err)
