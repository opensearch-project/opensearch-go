...
func TestStartPolicy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.StartPolicy(t.Context(), sm.StartPolicyReq{PolicyName: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.StartPolicy(t.Context(), sm.StartPolicyReq{PolicyName: "test-value"})
		require.Error(t, err)
