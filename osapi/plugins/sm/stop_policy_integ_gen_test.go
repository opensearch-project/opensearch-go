...
func TestStopPolicy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.StopPolicy(t.Context(), sm.StopPolicyReq{PolicyName: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.StopPolicy(t.Context(), sm.StopPolicyReq{PolicyName: "test-value"})
		require.Error(t, err)
