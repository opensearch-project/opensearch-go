...
func TestCreatePolicy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.CreatePolicy(t.Context(), sm.CreatePolicyReq{PolicyName: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.CreatePolicy(t.Context(), sm.CreatePolicyReq{PolicyName: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
