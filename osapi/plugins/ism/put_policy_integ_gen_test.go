...
func TestPutPolicy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.PutPolicy(t.Context(), ism.PutPolicyReq{PolicyID: "test-value", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.PutPolicy(t.Context(), ism.PutPolicyReq{PolicyID: "test-value", Body: strings.NewReader("{}")})
		require.Error(t, err)
