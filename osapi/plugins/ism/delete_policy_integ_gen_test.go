...
func TestDeletePolicy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.DeletePolicy(t.Context(), ism.DeletePolicyReq{PolicyID: "test-value"})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.DeletePolicy(t.Context(), ism.DeletePolicyReq{PolicyID: "test-value"})
		require.Error(t, err)
