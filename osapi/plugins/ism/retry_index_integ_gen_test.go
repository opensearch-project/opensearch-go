...
func TestRetryIndex(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.RetryIndex(t.Context(), &ism.RetryIndexReq{Params: ism.RetryIndexParams{Index: []string{name}}, Index: []string{index}, Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.RetryIndex(t.Context(), &ism.RetryIndexReq{Index: []string{index}, Body: strings.NewReader("{}")})
		require.Error(t, err)
