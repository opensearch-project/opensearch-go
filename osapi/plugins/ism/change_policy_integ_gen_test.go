...
func TestChangePolicy(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.ChangePolicy(t.Context(), &ism.ChangePolicyReq{Params: ism.ChangePolicyParams{Index: []string{name}}, Index: []string{index}, Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.ChangePolicy(t.Context(), &ism.ChangePolicyReq{Index: []string{index}, Body: strings.NewReader("{}")})
		require.Error(t, err)
