...
func TestPutScript(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		resp, err := client.PutScript(t.Context(), osapi.PutScriptReq{ID: "test-doc-1", Body: strings.NewReader("{}")})
		require.NoError(t, err)
	...
	t.Run("inspect", func(t *testing.T) {
		...
		res, err := failingClient.PutScript(t.Context(), osapi.PutScriptReq{ID: "test-doc-1", Body: strings.NewReader("{}")})
		require.Error(t, err)
